...
if [ `cat ${distdir}/ChangeLog | wc -l` = "0" ]; then
	...
	chmod u+w ${distdir}/ChangeLog && git log f12012e7616c191a8926432faf866c8e43854062..HEAD --stat --name-only --date=short --abbrev-commit > ${distdir}/ChangeLog && cat ${top_srcdir}/ChangeLog-CVS >> ${distdir}/ChangeLog
