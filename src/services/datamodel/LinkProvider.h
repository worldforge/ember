...
class LinkProvider: public DataProvider, virtual public SigC::Object
{
    //======================================================================
	...
	std::string getLinkDest();

	//----------------------------------------------------------------------
    // Constructors

	LinkProvider(std::string destPath);
    ...
    //======================================================================
    protected:
	void onSignal(PDataObject object, DataType event);
