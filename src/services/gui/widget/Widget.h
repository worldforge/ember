...
namespace dime {
  ...
  class Widget : public virtual SigC::Object
    ...
    protected:
      ...
      /**
       * Static Member containing next free ID number
       */
      static long theIDNext;
      ...
      virtual bool getVisible () const
	{
      ...
      /**
       * Returns this widget's unique ID number
       */
