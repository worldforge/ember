...
protected:
	void parseMatchElement(ModelMappingDefinition& definition, MatchDefinition& matchDef, Ember::TiXmlElement* element);
	void parseCaseElement(ModelMappingDefinition& definition, CaseDefinition& caseDef, Ember::TiXmlElement* element);
	void parseActionElement(ModelMappingDefinition& definition, ActionDefinition& actionDef, Ember::TiXmlElement* element);
