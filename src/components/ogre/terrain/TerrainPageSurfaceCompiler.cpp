...
void TerrainPageSurfaceCompiler::compileMaterial(Ogre::MaterialPtr material, std::map<int, TerrainPageSurfaceLayer*> terrainPageSurfaces, TerrainPageShadow* terrainPageShadow)
{
