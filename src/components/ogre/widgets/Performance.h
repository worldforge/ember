...
//
#ifndef EMBEROGREPERFORMANCE_H
#define EMBEROGREPERFORMANCE_H
...
/**
A widget for showing different performance values of the engine, to be used mainly for debugging and profiling.

@author Erik Hjortsberg
*/
class Performance : public Widget
{
public:
    Performance();
