...
//
#ifndef DIMEOGREGIVEWIDGET_H
#define DIMEOGREGIVEWIDGET_H
...
*/
class GiveWidget : public Widget
{


public:
    GiveWidget(GUIManager* guiManager);

    ~GiveWidget();
	void buildWidget();

protected:
	EmberEntity* mTargetEntity;
