...
static int tolua_collect_EmberOgre__Gui__Adapters__Ogre__ResourceListAdapter (lua_State* tolua_S)
{
 EmberOgre::Gui::Adapters::Ogre::ResourceListAdapter* self = (EmberOgre::Gui::Adapters::Ogre::ResourceListAdapter*) tolua_tousertype(tolua_S,1,0);
	delete self;
	return 0;
}
...
static int tolua_collect_Atlas__Objects__Root (lua_State* tolua_S)
{
 Atlas::Objects::Root* self = (Atlas::Objects::Root*) tolua_tousertype(tolua_S,1,0);
	delete self;
	return 0;
}
...
static int tolua_collect_EmberOgre__Authoring__EntityRecipeManager (lua_State* tolua_S)
{
 EmberOgre::Authoring::EntityRecipeManager* self = (EmberOgre::Authoring::EntityRecipeManager*) tolua_tousertype(tolua_S,1,0);
	delete self;
	return 0;
}
...
static int tolua_collect_EmberOgre__Authoring__GUIAdaptersStore__const_iterator (lua_State* tolua_S)
{
 EmberOgre::Authoring::GUIAdaptersStore::const_iterator* self = (EmberOgre::Authoring::GUIAdaptersStore::const_iterator*) tolua_tousertype(tolua_S,1,0);
	delete self;
	return 0;
}
...
static int tolua_collect_EmberOgre__Authoring__GUIAdapter (lua_State* tolua_S)
{
 EmberOgre::Authoring::GUIAdapter* self = (EmberOgre::Authoring::GUIAdapter*) tolua_tousertype(tolua_S,1,0);
	delete self;
	return 0;
}
...
static int tolua_collect_EmberOgre__Authoring__EntityRecipe (lua_State* tolua_S)
{
 EmberOgre::Authoring::EntityRecipe* self = (EmberOgre::Authoring::EntityRecipe*) tolua_tousertype(tolua_S,1,0);
	delete self;
	return 0;
}
...
static void tolua_reg_types (lua_State* tolua_S)
{
 ...
 tolua_usertype(tolua_S,"EmberOgre::Authoring::EntityMover");
 tolua_usertype(tolua_S,"std::set<std::string>");
 tolua_usertype(tolua_S,"EmberOgre::Gui::Adapters::Ogre::ResourceListAdapter");
 ...
 tolua_usertype(tolua_S,"EmberOgre::Terrain::TerrainManager");
 tolua_usertype(tolua_S,"EmberOgre::Gui::CompassCameraAnchor");
 tolua_usertype(tolua_S,"EmberOgre::Terrain::TerrainEditorOverlay");
 tolua_usertype(tolua_S,"virtual sigc::trackable");
 ...
 tolua_usertype(tolua_S,"EmberOgre::Authoring::EntityRecipePtr");
 ...
 tolua_usertype(tolua_S,"EmberOgre::Gui::Adapters::Eris::TypeTreeAdapter");
 ...
 tolua_usertype(tolua_S,"EmberOgre::Authoring::GUIAdaptersStore");
 ...
 tolua_usertype(tolua_S,"EmberOgre::Authoring::EntityRecipe");
 ...
 tolua_usertype(tolua_S,"EmberOgre::Authoring::EntityMoveManager");
 ...
 tolua_usertype(tolua_S,"Ember::Singleton<EmberOgre::Authoring::EntityRecipeManager>");
 ...
 tolua_usertype(tolua_S,"EmberOgre::Gui::AtlasHelper");
 ...
 tolua_usertype(tolua_S,"EmberOgre::Authoring::GUIAdapter");
...
#endif
  {
   float tolua_ret = (float)  self->getClosestPickingDistance();
...
/* get function: EventMovementModeChanged of class  EmberOgre::MovementController */
#ifndef TOLUA_DISABLE_tolua_get_EmberOgre__MovementController_EventMovementModeChanged
static int tolua_get_EmberOgre__MovementController_EventMovementModeChanged(lua_State* tolua_S)
{
  EmberOgre::MovementController* self = (EmberOgre::MovementController*)  tolua_tousertype(tolua_S,1,0);
#ifndef TOLUA_RELEASE
  if (!self) tolua_error(tolua_S,"invalid 'self' in accessing variable 'EventMovementModeChanged'",NULL);
#endif
  tolua_pushusertype(tolua_S,(void*)&self->EventMovementModeChanged,"sigc::signal<void,EmberOgre::MovementControllerMode::Mode>");
 return 1;
}
#endif //#ifndef TOLUA_DISABLE

/* set function: EventMovementModeChanged of class  EmberOgre::MovementController */
#ifndef TOLUA_DISABLE_tolua_set_EmberOgre__MovementController_EventMovementModeChanged
static int tolua_set_EmberOgre__MovementController_EventMovementModeChanged(lua_State* tolua_S)
{
  EmberOgre::MovementController* self = (EmberOgre::MovementController*)  tolua_tousertype(tolua_S,1,0);
#ifndef TOLUA_RELEASE
  tolua_Error tolua_err;
  if (!self) tolua_error(tolua_S,"invalid 'self' in accessing variable 'EventMovementModeChanged'",NULL);
  if (!tolua_isusertype(tolua_S,2,"sigc::signal<void,EmberOgre::MovementControllerMode::Mode>",0,&tolua_err))
   tolua_error(tolua_S,"#vinvalid type in variable assignment.",&tolua_err);
#endif
  self->EventMovementModeChanged = *((sigc::signal<void,EmberOgre::MovementControllerMode::Mode>*)  tolua_tousertype(tolua_S,2,0))
;
 return 0;
}
#endif //#ifndef TOLUA_DISABLE

/* method: moveToPoint of class  EmberOgre::MovementController */
#ifndef TOLUA_DISABLE_tolua_EmberOgre_EmberOgre_MovementController_moveToPoint00
static int tolua_EmberOgre_EmberOgre_MovementController_moveToPoint00(lua_State* tolua_S)
{
#ifndef TOLUA_RELEASE
 tolua_Error tolua_err;
 if (
     !tolua_isusertype(tolua_S,1,"EmberOgre::MovementController",0,&tolua_err) ||
...
/* method: teleportTo of class  EmberOgre::MovementController */
#ifndef TOLUA_DISABLE_tolua_EmberOgre_EmberOgre_MovementController_teleportTo00
static int tolua_EmberOgre_EmberOgre_MovementController_teleportTo00(lua_State* tolua_S)
{
#ifndef TOLUA_RELEASE
 tolua_Error tolua_err;
 if (
...
/* method: getMode of class  EmberOgre::MovementController */
#ifndef TOLUA_DISABLE_tolua_EmberOgre_EmberOgre_MovementController_getMode00
static int tolua_EmberOgre_EmberOgre_MovementController_getMode00(lua_State* tolua_S)
{
#ifndef TOLUA_RELEASE
 tolua_Error tolua_err;
 if (
     !tolua_isusertype(tolua_S,1,"const EmberOgre::MovementController",0,&tolua_err) ||
     !tolua_isnoobj(tolua_S,2,&tolua_err)
 )
  goto tolua_lerror;
 else
#endif
 {
  const EmberOgre::MovementController* self = (const EmberOgre::MovementController*)  tolua_tousertype(tolua_S,1,0);
#ifndef TOLUA_RELEASE
  if (!self) tolua_error(tolua_S,"invalid 'self' in function 'getMode'",NULL);
#endif
  {
   EmberOgre::MovementControllerMode::Mode tolua_ret = (EmberOgre::MovementControllerMode::Mode)  self->getMode();
   tolua_pushnumber(tolua_S,(lua_Number)tolua_ret);
  }
 }
 return 1;
...
/* method: getClientSideAvatarPosition of class  EmberOgre::Avatar */
#ifndef TOLUA_DISABLE_tolua_EmberOgre_EmberOgre_Avatar_getClientSideAvatarPosition00
static int tolua_EmberOgre_EmberOgre_Avatar_getClientSideAvatarPosition00(lua_State* tolua_S)
{
#ifndef TOLUA_RELEASE
 tolua_Error tolua_err;
 if (
...
#endif
 {
  const EmberOgre::Avatar* self = (const EmberOgre::Avatar*)  tolua_tousertype(tolua_S,1,0);
#ifndef TOLUA_RELEASE
  if (!self) tolua_error(tolua_S,"invalid 'self' in function 'getClientSideAvatarPosition'",NULL);
#endif
  {
   WFMath::Point<3> tolua_ret = (WFMath::Point<3>)  self->getClientSideAvatarPosition();
   {
#ifdef __cplusplus
...
#ifndef TOLUA_RELEASE
 tolua_lerror:
 tolua_error(tolua_S,"#ferror in function 'getClientSideAvatarPosition'.",&tolua_err);
 return 0;
#endif
}
#endif //#ifndef TOLUA_DISABLE

/* method: getClientSideAvatarOrientation of class  EmberOgre::Avatar */
#ifndef TOLUA_DISABLE_tolua_EmberOgre_EmberOgre_Avatar_getClientSideAvatarOrientation00
static int tolua_EmberOgre_EmberOgre_Avatar_getClientSideAvatarOrientation00(lua_State* tolua_S)
{
#ifndef TOLUA_RELEASE
 tolua_Error tolua_err;
 if (
...
#endif
 {
  const EmberOgre::Avatar* self = (const EmberOgre::Avatar*)  tolua_tousertype(tolua_S,1,0);
#ifndef TOLUA_RELEASE
  if (!self) tolua_error(tolua_S,"invalid 'self' in function 'getClientSideAvatarOrientation'",NULL);
#endif
  {
   WFMath::Quaternion tolua_ret = (WFMath::Quaternion)  self->getClientSideAvatarOrientation();
   {
#ifdef __cplusplus
...
#ifndef TOLUA_RELEASE
 tolua_lerror:
 tolua_error(tolua_S,"#ferror in function 'getClientSideAvatarOrientation'.",&tolua_err);
 return 0;
#endif
}
#endif //#ifndef TOLUA_DISABLE
...
/* method: getAuthoringManager of class  EmberOgre::EmberEntityFactory */
#ifndef TOLUA_DISABLE_tolua_EmberOgre_EmberOgre_EmberEntityFactory_getAuthoringManager00
static int tolua_EmberOgre_EmberOgre_EmberEntityFactory_getAuthoringManager00(lua_State* tolua_S)
{
#ifndef TOLUA_RELEASE
 tolua_Error tolua_err;
 if (
...
#endif
 {
  const EmberOgre::EmberEntityFactory* self = (const EmberOgre::EmberEntityFactory*)  tolua_tousertype(tolua_S,1,0);
#ifndef TOLUA_RELEASE
  if (!self) tolua_error(tolua_S,"invalid 'self' in function 'getAuthoringManager'",NULL);
#endif
  {
   EmberOgre::Authoring::AuthoringManager& tolua_ret = (EmberOgre::Authoring::AuthoringManager&)  self->getAuthoringManager();
   tolua_pushusertype(tolua_S,(void*)&tolua_ret,"EmberOgre::Authoring::AuthoringManager");
  }
 }
 return 1;
#ifndef TOLUA_RELEASE
 tolua_lerror:
 tolua_error(tolua_S,"#ferror in function 'getAuthoringManager'.",&tolua_err);
 return 0;
#endif
}
#endif //#ifndef TOLUA_DISABLE
...
/* method: getAttachedEntity of class  EmberOgre::EmberEntity */
#ifndef TOLUA_DISABLE_tolua_EmberOgre_EmberOgre_EmberEntity_getAttachedEntity00
static int tolua_EmberOgre_EmberOgre_EmberEntity_getAttachedEntity00(lua_State* tolua_S)
{
#ifndef TOLUA_RELEASE
 tolua_Error tolua_err;
 if (
 ...
 {
  EmberOgre::EmberEntity* self = (EmberOgre::EmberEntity*)  tolua_tousertype(tolua_S,1,0);
  const std::string namedPoint = ((const std::string)  tolua_tocppstring(tolua_S,2,0));
#ifndef TOLUA_RELEASE
  if (!self) tolua_error(tolua_S,"invalid 'self' in function 'getAttachedEntity'",NULL);
#endif
  {
   EmberOgre::EmberEntity* tolua_ret = (EmberOgre::EmberEntity*)  self->getAttachedEntity(namedPoint);
   tolua_pushusertype(tolua_S,(void*)tolua_ret,"EmberOgre::EmberEntity");
   tolua_pushcppstring(tolua_S,(const char*)namedPoint);
  }
 }
 return 2;
#ifndef TOLUA_RELEASE
 tolua_lerror:
 tolua_error(tolua_S,"#ferror in function 'getAttachedEntity'.",&tolua_err);
 return 0;
#endif
}
#endif //#ifndef TOLUA_DISABLE
...
/* method: getMin of class  EmberOgre::Terrain::TerrainManager */
#ifndef TOLUA_DISABLE_tolua_EmberOgre_EmberOgre_Terrain_TerrainManager_getMin00
static int tolua_EmberOgre_EmberOgre_Terrain_TerrainManager_getMin00(lua_State* tolua_S)
{
#ifndef TOLUA_RELEASE
 tolua_Error tolua_err;
 if (
...
/* method: getPageMetersSize of class  EmberOgre::Terrain::TerrainManager */
#ifndef TOLUA_DISABLE_tolua_EmberOgre_EmberOgre_Terrain_TerrainManager_getPageMetersSize00
static int tolua_EmberOgre_EmberOgre_Terrain_TerrainManager_getPageMetersSize00(lua_State* tolua_S)
{
#ifndef TOLUA_RELEASE
 tolua_Error tolua_err;
 if (
     !tolua_isusertype(tolua_S,1,"EmberOgre::Terrain::TerrainManager",0,&tolua_err) ||
     !tolua_isnoobj(tolua_S,2,&tolua_err)
 )
  goto tolua_lerror;
 else
#endif
 {
  EmberOgre::Terrain::TerrainManager* self = (EmberOgre::Terrain::TerrainManager*)  tolua_tousertype(tolua_S,1,0);
#ifndef TOLUA_RELEASE
...
/* method: updateShadows of class  EmberOgre::Terrain::TerrainManager */
#ifndef TOLUA_DISABLE_tolua_EmberOgre_EmberOgre_Terrain_TerrainManager_updateShadows00
static int tolua_EmberOgre_EmberOgre_Terrain_TerrainManager_updateShadows00(lua_State* tolua_S)
{
#ifndef TOLUA_RELEASE
 tolua_Error tolua_err;
 if (
...
/* get function: UpdateShadows of class  EmberOgre::Terrain::TerrainManager */
#ifndef TOLUA_DISABLE_tolua_get_EmberOgre__Terrain__TerrainManager_UpdateShadows
static int tolua_get_EmberOgre__Terrain__TerrainManager_UpdateShadows(lua_State* tolua_S)
{
  EmberOgre::Terrain::TerrainManager* self = (EmberOgre::Terrain::TerrainManager*)  tolua_tousertype(tolua_S,1,0);
#ifndef TOLUA_RELEASE
...
/* get function: EventTerrainPageGeometryUpdated of class  EmberOgre::Terrain::TerrainManager */
#ifndef TOLUA_DISABLE_tolua_get_EmberOgre__Terrain__TerrainManager_EventTerrainPageGeometryUpdated
static int tolua_get_EmberOgre__Terrain__TerrainManager_EventTerrainPageGeometryUpdated(lua_State* tolua_S)
{
  EmberOgre::Terrain::TerrainManager* self = (EmberOgre::Terrain::TerrainManager*)  tolua_tousertype(tolua_S,1,0);
#ifndef TOLUA_RELEASE
...
/* set function: EventTerrainPageGeometryUpdated of class  EmberOgre::Terrain::TerrainManager */
#ifndef TOLUA_DISABLE_tolua_set_EmberOgre__Terrain__TerrainManager_EventTerrainPageGeometryUpdated
static int tolua_set_EmberOgre__Terrain__TerrainManager_EventTerrainPageGeometryUpdated(lua_State* tolua_S)
{
  EmberOgre::Terrain::TerrainManager* self = (EmberOgre::Terrain::TerrainManager*)  tolua_tousertype(tolua_S,1,0);
#ifndef TOLUA_RELEASE
  tolua_Error tolua_err;
...
/* get function: EventOverlayCreated of class  EmberOgre::Terrain::TerrainEditor */
#ifndef TOLUA_DISABLE_tolua_get_EmberOgre__Terrain__TerrainEditor_EventOverlayCreated
static int tolua_get_EmberOgre__Terrain__TerrainEditor_EventOverlayCreated(lua_State* tolua_S)
{
  EmberOgre::Terrain::TerrainEditor* self = (EmberOgre::Terrain::TerrainEditor*)  tolua_tousertype(tolua_S,1,0);
#ifndef TOLUA_RELEASE
  if (!self) tolua_error(tolua_S,"invalid 'self' in accessing variable 'EventOverlayCreated'",NULL);
#endif
  tolua_pushusertype(tolua_S,(void*)&self->EventOverlayCreated,"sigc::signal<void,EmberOgre::Terrain::TerrainEditorOverlay&>");
 return 1;
}
#endif //#ifndef TOLUA_DISABLE

/* set function: EventOverlayCreated of class  EmberOgre::Terrain::TerrainEditor */
#ifndef TOLUA_DISABLE_tolua_set_EmberOgre__Terrain__TerrainEditor_EventOverlayCreated
static int tolua_set_EmberOgre__Terrain__TerrainEditor_EventOverlayCreated(lua_State* tolua_S)
{
  EmberOgre::Terrain::TerrainEditor* self = (EmberOgre::Terrain::TerrainEditor*)  tolua_tousertype(tolua_S,1,0);
#ifndef TOLUA_RELEASE
  tolua_Error tolua_err;
  if (!self) tolua_error(tolua_S,"invalid 'self' in accessing variable 'EventOverlayCreated'",NULL);
  if (!tolua_isusertype(tolua_S,2,"sigc::signal<void,EmberOgre::Terrain::TerrainEditorOverlay&>",0,&tolua_err))
   tolua_error(tolua_S,"#vinvalid type in variable assignment.",&tolua_err);
#endif
  self->EventOverlayCreated = *((sigc::signal<void,EmberOgre::Terrain::TerrainEditorOverlay&>*)  tolua_tousertype(tolua_S,2,0))
;
 return 0;
}
#endif //#ifndef TOLUA_DISABLE
...
/* method: setFalloff of class  EmberOgre::Terrain::TerrainEditor */
#ifndef TOLUA_DISABLE_tolua_EmberOgre_EmberOgre_Terrain_TerrainEditor_setFalloff00
static int tolua_EmberOgre_EmberOgre_Terrain_TerrainEditor_setFalloff00(lua_State* tolua_S)
{
#ifndef TOLUA_RELEASE
 tolua_Error tolua_err;
 if (
...
/* method: commitAction of class  EmberOgre::Terrain::TerrainEditorOverlay */
#ifndef TOLUA_DISABLE_tolua_EmberOgre_EmberOgre_Terrain_TerrainEditorOverlay_commitAction00
static int tolua_EmberOgre_EmberOgre_Terrain_TerrainEditorOverlay_commitAction00(lua_State* tolua_S)
{
#ifndef TOLUA_RELEASE
 tolua_Error tolua_err;
 if (
     !tolua_isusertype(tolua_S,1,"EmberOgre::Terrain::TerrainEditorOverlay",0,&tolua_err) ||
...
#endif
 {
  EmberOgre::Terrain::TerrainEditorOverlay* self = (EmberOgre::Terrain::TerrainEditorOverlay*)  tolua_tousertype(tolua_S,1,0);
...
/* method: getCurrentBasePointUserObject of class  EmberOgre::Terrain::TerrainEditorOverlay */
#ifndef TOLUA_DISABLE_tolua_EmberOgre_EmberOgre_Terrain_TerrainEditorOverlay_getCurrentBasePointUserObject00
static int tolua_EmberOgre_EmberOgre_Terrain_TerrainEditorOverlay_getCurrentBasePointUserObject00(lua_State* tolua_S)
{
#ifndef TOLUA_RELEASE
 tolua_Error tolua_err;
 if (
     !tolua_isusertype(tolua_S,1,"const EmberOgre::Terrain::TerrainEditorOverlay",0,&tolua_err) ||
     !tolua_isnoobj(tolua_S,2,&tolua_err)
 )
  goto tolua_lerror;
 else
#endif
 {
  const EmberOgre::Terrain::TerrainEditorOverlay* self = (const EmberOgre::Terrain::TerrainEditorOverlay*)  tolua_tousertype(tolua_S,1,0);
#ifndef TOLUA_RELEASE
...
/* method: sendChangesToServer of class  EmberOgre::Terrain::TerrainEditorOverlay */
#ifndef TOLUA_DISABLE_tolua_EmberOgre_EmberOgre_Terrain_TerrainEditorOverlay_sendChangesToServer00
static int tolua_EmberOgre_EmberOgre_Terrain_TerrainEditorOverlay_sendChangesToServer00(lua_State* tolua_S)
{
#ifndef TOLUA_RELEASE
 tolua_Error tolua_err;
 if (
...
/* method: createAction of class  EmberOgre::Terrain::TerrainEditorOverlay */
#ifndef TOLUA_DISABLE_tolua_EmberOgre_EmberOgre_Terrain_TerrainEditorOverlay_createAction00
static int tolua_EmberOgre_EmberOgre_Terrain_TerrainEditorOverlay_createAction00(lua_State* tolua_S)
{
#ifndef TOLUA_RELEASE
 tolua_Error tolua_err;
 if (
...
/* method: undoLastAction of class  EmberOgre::Terrain::TerrainEditorOverlay */
#ifndef TOLUA_DISABLE_tolua_EmberOgre_EmberOgre_Terrain_TerrainEditorOverlay_undoLastAction00
static int tolua_EmberOgre_EmberOgre_Terrain_TerrainEditorOverlay_undoLastAction00(lua_State* tolua_S)
{
#ifndef TOLUA_RELEASE
 tolua_Error tolua_err;
 if (
...
/* method: redoAction of class  EmberOgre::Terrain::TerrainEditorOverlay */
#ifndef TOLUA_DISABLE_tolua_EmberOgre_EmberOgre_Terrain_TerrainEditorOverlay_redoAction00
static int tolua_EmberOgre_EmberOgre_Terrain_TerrainEditorOverlay_redoAction00(lua_State* tolua_S)
{
#ifndef TOLUA_RELEASE
 tolua_Error tolua_err;
 if (
...
/* get function: EventPickedBasePoint of class  EmberOgre::Terrain::TerrainEditorOverlay */
#ifndef TOLUA_DISABLE_tolua_get_EmberOgre__Terrain__TerrainEditorOverlay_EventPickedBasePoint
static int tolua_get_EmberOgre__Terrain__TerrainEditorOverlay_EventPickedBasePoint(lua_State* tolua_S)
{
  EmberOgre::Terrain::TerrainEditorOverlay* self = (EmberOgre::Terrain::TerrainEditorOverlay*)  tolua_tousertype(tolua_S,1,0);
#ifndef TOLUA_RELEASE
...
/* set function: EventPickedBasePoint of class  EmberOgre::Terrain::TerrainEditorOverlay */
#ifndef TOLUA_DISABLE_tolua_set_EmberOgre__Terrain__TerrainEditorOverlay_EventPickedBasePoint
static int tolua_set_EmberOgre__Terrain__TerrainEditorOverlay_EventPickedBasePoint(lua_State* tolua_S)
{
  EmberOgre::Terrain::TerrainEditorOverlay* self = (EmberOgre::Terrain::TerrainEditorOverlay*)  tolua_tousertype(tolua_S,1,0);
#ifndef TOLUA_RELEASE
  tolua_Error tolua_err;
...
/* get function: EventActionCreated of class  EmberOgre::Terrain::TerrainEditorOverlay */
#ifndef TOLUA_DISABLE_tolua_get_EmberOgre__Terrain__TerrainEditorOverlay_EventActionCreated
static int tolua_get_EmberOgre__Terrain__TerrainEditorOverlay_EventActionCreated(lua_State* tolua_S)
{
  EmberOgre::Terrain::TerrainEditorOverlay* self = (EmberOgre::Terrain::TerrainEditorOverlay*)  tolua_tousertype(tolua_S,1,0);
#ifndef TOLUA_RELEASE
...
/* set function: EventActionCreated of class  EmberOgre::Terrain::TerrainEditorOverlay */
#ifndef TOLUA_DISABLE_tolua_set_EmberOgre__Terrain__TerrainEditorOverlay_EventActionCreated
static int tolua_set_EmberOgre__Terrain__TerrainEditorOverlay_EventActionCreated(lua_State* tolua_S)
{
  EmberOgre::Terrain::TerrainEditorOverlay* self = (EmberOgre::Terrain::TerrainEditorOverlay*)  tolua_tousertype(tolua_S,1,0);
#ifndef TOLUA_RELEASE
  tolua_Error tolua_err;
...
/* get function: EventSelectedBasePointUpdatedPosition of class  EmberOgre::Terrain::TerrainEditorOverlay */
#ifndef TOLUA_DISABLE_tolua_get_EmberOgre__Terrain__TerrainEditorOverlay_EventSelectedBasePointUpdatedPosition
static int tolua_get_EmberOgre__Terrain__TerrainEditorOverlay_EventSelectedBasePointUpdatedPosition(lua_State* tolua_S)
{
  EmberOgre::Terrain::TerrainEditorOverlay* self = (EmberOgre::Terrain::TerrainEditorOverlay*)  tolua_tousertype(tolua_S,1,0);
#ifndef TOLUA_RELEASE
...
/* set function: EventSelectedBasePointUpdatedPosition of class  EmberOgre::Terrain::TerrainEditorOverlay */
#ifndef TOLUA_DISABLE_tolua_set_EmberOgre__Terrain__TerrainEditorOverlay_EventSelectedBasePointUpdatedPosition
static int tolua_set_EmberOgre__Terrain__TerrainEditorOverlay_EventSelectedBasePointUpdatedPosition(lua_State* tolua_S)
{
  EmberOgre::Terrain::TerrainEditorOverlay* self = (EmberOgre::Terrain::TerrainEditorOverlay*)  tolua_tousertype(tolua_S,1,0);
#ifndef TOLUA_RELEASE
  tolua_Error tolua_err;
...
/* method: updateAnimation of class  EmberOgre::IAnimated */
#ifndef TOLUA_DISABLE_tolua_EmberOgre_EmberOgre_IAnimated_updateAnimation00
static int tolua_EmberOgre_EmberOgre_IAnimated_updateAnimation00(lua_State* tolua_S)
{
#ifndef TOLUA_RELEASE
 tolua_Error tolua_err;
 if (
     !tolua_isusertype(tolua_S,1,"EmberOgre::IAnimated",0,&tolua_err) ||
     !tolua_isnumber(tolua_S,2,0,&tolua_err) ||
     !tolua_isnoobj(tolua_S,3,&tolua_err)
 )
  goto tolua_lerror;
...
#endif
 {
  EmberOgre::IAnimated* self = (EmberOgre::IAnimated*)  tolua_tousertype(tolua_S,1,0);
  float timeSlice = ((float)  tolua_tonumber(tolua_S,2,0));
#ifndef TOLUA_RELEASE
  if (!self) tolua_error(tolua_S,"invalid 'self' in function 'updateAnimation'",NULL);
#endif
  {
   self->updateAnimation(timeSlice);
  }
 }
 return 0;
#ifndef TOLUA_RELEASE
...
/* method: resolveFilePathForMesh of class  EmberOgre::Gui::AssetsManager */
#ifndef TOLUA_DISABLE_tolua_EmberOgre_EmberOgre_Gui_AssetsManager_resolveFilePathForMesh00
static int tolua_EmberOgre_EmberOgre_Gui_AssetsManager_resolveFilePathForMesh00(lua_State* tolua_S)
{
#ifndef TOLUA_RELEASE
 tolua_Error tolua_err;
 if (
     !tolua_isusertype(tolua_S,1,"EmberOgre::Gui::AssetsManager",0,&tolua_err) ||
     !tolua_isusertype(tolua_S,2,"Ogre::MeshPtr",0,&tolua_err) ||
     !tolua_isnoobj(tolua_S,3,&tolua_err)
 )
  goto tolua_lerror;
 else
 ...
 {
  EmberOgre::Gui::AssetsManager* self = (EmberOgre::Gui::AssetsManager*)  tolua_tousertype(tolua_S,1,0);
  Ogre::MeshPtr meshPtr = *((Ogre::MeshPtr*)  tolua_tousertype(tolua_S,2,0));
#ifndef TOLUA_RELEASE
  if (!self) tolua_error(tolua_S,"invalid 'self' in function 'resolveFilePathForMesh'",NULL);
#endif
  {
   std::string tolua_ret = (std::string)  self->resolveFilePathForMesh(meshPtr);
   tolua_pushcppstring(tolua_S,(const char*)tolua_ret);
  }
 }
 return 1;
#ifndef TOLUA_RELEASE
 tolua_lerror:
 tolua_error(tolua_S,"#ferror in function 'resolveFilePathForMesh'.",&tolua_err);
 return 0;
#endif
}
#endif //#ifndef TOLUA_DISABLE

/* method: exportMesh of class  EmberOgre::Gui::AssetsManager */
#ifndef TOLUA_DISABLE_tolua_EmberOgre_EmberOgre_Gui_AssetsManager_exportMesh00
static int tolua_EmberOgre_EmberOgre_Gui_AssetsManager_exportMesh00(lua_State* tolua_S)
{
#ifndef TOLUA_RELEASE
 tolua_Error tolua_err;
 if (
 ...
 {
  EmberOgre::Gui::AssetsManager* self = (EmberOgre::Gui::AssetsManager*)  tolua_tousertype(tolua_S,1,0);
  Ogre::MeshPtr mesh = *((Ogre::MeshPtr*)  tolua_tousertype(tolua_S,2,0));
  const std::string filePath = ((const std::string)  tolua_tocppstring(tolua_S,3,0));
#ifndef TOLUA_RELEASE
  if (!self) tolua_error(tolua_S,"invalid 'self' in function 'exportMesh'",NULL);
#endif
  {
   bool tolua_ret = (bool)  self->exportMesh(mesh,filePath);
   tolua_pushboolean(tolua_S,(bool)tolua_ret);
   tolua_pushcppstring(tolua_S,(const char*)filePath);
  }
 }
...
#ifndef TOLUA_RELEASE
 tolua_lerror:
 tolua_error(tolua_S,"#ferror in function 'exportMesh'.",&tolua_err);
 return 0;
#endif
}
#endif //#ifndef TOLUA_DISABLE
...
static int tolua_EmberOgre_EmberOgre_Gui_AtlasHelper_serialize00(lua_State* tolua_S)
{
 ...
 tolua_Error tolua_err;
 if (
     !tolua_isusertable(tolua_S,1,"EmberOgre::Gui::AtlasHelper",0,&tolua_err) ||
...
#endif
 {
  ...
  {
   std::string tolua_ret = (std::string)  EmberOgre::Gui::AtlasHelper::serialize(*obj);
   tolua_pushcppstring(tolua_S,(const char*)tolua_ret);
  }
 }
 return 1;
...
/* method: serialize of class  EmberOgre::Gui::AtlasHelper */
#ifndef TOLUA_DISABLE_tolua_EmberOgre_EmberOgre_Gui_AtlasHelper_serialize01
static int tolua_EmberOgre_EmberOgre_Gui_AtlasHelper_serialize01(lua_State* tolua_S)
{
 tolua_Error tolua_err;
 if (
     !tolua_isusertable(tolua_S,1,"EmberOgre::Gui::AtlasHelper",0,&tolua_err) ||
 ...
 {
  const Atlas::Objects::Root* obj = ((const Atlas::Objects::Root*)  tolua_tousertype(tolua_S,2,0));
  const std::string codecType = ((const std::string)  tolua_tocppstring(tolua_S,3,0));
  {
   std::string tolua_ret = (std::string)  EmberOgre::Gui::AtlasHelper::serialize(*obj,codecType);
   tolua_pushcppstring(tolua_S,(const char*)tolua_ret);
   tolua_pushcppstring(tolua_S,(const char*)codecType);
  }
 }
 return 2;
tolua_lerror:
 return tolua_EmberOgre_EmberOgre_Gui_AtlasHelper_serialize00(tolua_S);
}
#endif //#ifndef TOLUA_DISABLE
...
/* method: new of class  EmberOgre::Gui::Adapters::Eris::TypeTreeAdapter */
#ifndef TOLUA_DISABLE_tolua_EmberOgre_EmberOgre_Gui_Adapters_Eris_TypeTreeAdapter_new00
static int tolua_EmberOgre_EmberOgre_Gui_Adapters_Eris_TypeTreeAdapter_new00(lua_State* tolua_S)
{
#ifndef TOLUA_RELEASE
 tolua_Error tolua_err;
 if (
     !tolua_isusertable(tolua_S,1,"EmberOgre::Gui::Adapters::Eris::TypeTreeAdapter",0,&tolua_err) ||
     !tolua_isusertype(tolua_S,2,"Eris::TypeService",0,&tolua_err) ||
     !tolua_isusertype(tolua_S,3,"CEGUI::Tree",0,&tolua_err) ||
     !tolua_isnoobj(tolua_S,4,&tolua_err)
 )
  goto tolua_lerror;
 else
#endif
 {
  ...
  CEGUI::Tree* treeWidget = ((CEGUI::Tree*)  tolua_tousertype(tolua_S,3,0));
  {
   EmberOgre::Gui::Adapters::Eris::TypeTreeAdapter* tolua_ret = (EmberOgre::Gui::Adapters::Eris::TypeTreeAdapter*)  new EmberOgre::Gui::Adapters::Eris::TypeTreeAdapter(*typeService,*treeWidget);
   tolua_pushusertype(tolua_S,(void*)tolua_ret,"EmberOgre::Gui::Adapters::Eris::TypeTreeAdapter");
  }
 }
 return 1;
#ifndef TOLUA_RELEASE
...
/* method: new_local of class  EmberOgre::Gui::Adapters::Eris::TypeTreeAdapter */
#ifndef TOLUA_DISABLE_tolua_EmberOgre_EmberOgre_Gui_Adapters_Eris_TypeTreeAdapter_new00_local
static int tolua_EmberOgre_EmberOgre_Gui_Adapters_Eris_TypeTreeAdapter_new00_local(lua_State* tolua_S)
{
#ifndef TOLUA_RELEASE
 tolua_Error tolua_err;
 if (
...
#endif
 {
  ...
  {
   EmberOgre::Gui::Adapters::Eris::TypeTreeAdapter* tolua_ret = (EmberOgre::Gui::Adapters::Eris::TypeTreeAdapter*)  new EmberOgre::Gui::Adapters::Eris::TypeTreeAdapter(*typeService,*treeWidget);
   tolua_pushusertype_and_takeownership(tolua_S,(void *)tolua_ret,"EmberOgre::Gui::Adapters::Eris::TypeTreeAdapter");
  }
 }
 return 1;
#ifndef TOLUA_RELEASE
...
/* method: delete of class  EmberOgre::Gui::Adapters::Eris::TypeTreeAdapter */
#ifndef TOLUA_DISABLE_tolua_EmberOgre_EmberOgre_Gui_Adapters_Eris_TypeTreeAdapter_delete00
static int tolua_EmberOgre_EmberOgre_Gui_Adapters_Eris_TypeTreeAdapter_delete00(lua_State* tolua_S)
{
#ifndef TOLUA_RELEASE
 tolua_Error tolua_err;
 if (
     !tolua_isusertype(tolua_S,1,"EmberOgre::Gui::Adapters::Eris::TypeTreeAdapter",0,&tolua_err) ||
     !tolua_isnoobj(tolua_S,2,&tolua_err)
 )
  goto tolua_lerror;
 else
...
/* method: initialize of class  EmberOgre::Gui::Adapters::Eris::TypeTreeAdapter */
#ifndef TOLUA_DISABLE_tolua_EmberOgre_EmberOgre_Gui_Adapters_Eris_TypeTreeAdapter_initialize00
static int tolua_EmberOgre_EmberOgre_Gui_Adapters_Eris_TypeTreeAdapter_initialize00(lua_State* tolua_S)
{
#ifndef TOLUA_RELEASE
 tolua_Error tolua_err;
 if (
 ...
 {
  EmberOgre::Gui::Adapters::Eris::TypeTreeAdapter* self = (EmberOgre::Gui::Adapters::Eris::TypeTreeAdapter*)  tolua_tousertype(tolua_S,1,0);
  const std::string rootTypeName = ((const std::string)  tolua_tocppstring(tolua_S,2,0));
#ifndef TOLUA_RELEASE
  if (!self) tolua_error(tolua_S,"invalid 'self' in function 'initialize'",NULL);
#endif
  {
   bool tolua_ret = (bool)  self->initialize(rootTypeName);
   tolua_pushboolean(tolua_S,(bool)tolua_ret);
   tolua_pushcppstring(tolua_S,(const char*)rootTypeName);
  }
 }
 return 2;
#ifndef TOLUA_RELEASE
...
/* method: getSelectedTypeInfo of class  EmberOgre::Gui::Adapters::Eris::TypeTreeAdapter */
#ifndef TOLUA_DISABLE_tolua_EmberOgre_EmberOgre_Gui_Adapters_Eris_TypeTreeAdapter_getSelectedTypeInfo00
static int tolua_EmberOgre_EmberOgre_Gui_Adapters_Eris_TypeTreeAdapter_getSelectedTypeInfo00(lua_State* tolua_S)
{
#ifndef TOLUA_RELEASE
 tolua_Error tolua_err;
 if (
...
#endif
 {
  EmberOgre::Gui::Adapters::Eris::TypeTreeAdapter* self = (EmberOgre::Gui::Adapters::Eris::TypeTreeAdapter*)  tolua_tousertype(tolua_S,1,0);
#ifndef TOLUA_RELEASE
  if (!self) tolua_error(tolua_S,"invalid 'self' in function 'getSelectedTypeInfo'",NULL);
#endif
  {
   Eris::TypeInfo* tolua_ret = (Eris::TypeInfo*)  self->getSelectedTypeInfo();
...
#ifndef TOLUA_RELEASE
 tolua_lerror:
 tolua_error(tolua_S,"#ferror in function 'getSelectedTypeInfo'.",&tolua_err);
 return 0;
#endif
}
#endif //#ifndef TOLUA_DISABLE

/* method: new of class  EmberOgre::Gui::Adapters::Ogre::ResourceListAdapter */
#ifndef TOLUA_DISABLE_tolua_EmberOgre_EmberOgre_Gui_Adapters_Ogre_ResourceListAdapter_new00
static int tolua_EmberOgre_EmberOgre_Gui_Adapters_Ogre_ResourceListAdapter_new00(lua_State* tolua_S)
{
#ifndef TOLUA_RELEASE
 tolua_Error tolua_err;
 if (
     !tolua_isusertable(tolua_S,1,"EmberOgre::Gui::Adapters::Ogre::ResourceListAdapter",0,&tolua_err) ||
     !tolua_isusertype(tolua_S,2,"EmberOgre::Gui::ListHolder",0,&tolua_err) ||
     !tolua_isusertype(tolua_S,3,"Ogre::ResourceManager",0,&tolua_err) ||
     !tolua_isnoobj(tolua_S,4,&tolua_err)
 )
  goto tolua_lerror;
 else
#endif
 {
  EmberOgre::Gui::ListHolder* listHolder = ((EmberOgre::Gui::ListHolder*)  tolua_tousertype(tolua_S,2,0));
  Ogre::ResourceManager* resourceManager = ((Ogre::ResourceManager*)  tolua_tousertype(tolua_S,3,0));
  {
   EmberOgre::Gui::Adapters::Ogre::ResourceListAdapter* tolua_ret = (EmberOgre::Gui::Adapters::Ogre::ResourceListAdapter*)  new EmberOgre::Gui::Adapters::Ogre::ResourceListAdapter(listHolder,resourceManager);
   tolua_pushusertype(tolua_S,(void*)tolua_ret,"EmberOgre::Gui::Adapters::Ogre::ResourceListAdapter");
  }
 }
 return 1;
#ifndef TOLUA_RELEASE
...
/* method: new_local of class  EmberOgre::Gui::Adapters::Ogre::ResourceListAdapter */
#ifndef TOLUA_DISABLE_tolua_EmberOgre_EmberOgre_Gui_Adapters_Ogre_ResourceListAdapter_new00_local
static int tolua_EmberOgre_EmberOgre_Gui_Adapters_Ogre_ResourceListAdapter_new00_local(lua_State* tolua_S)
{
#ifndef TOLUA_RELEASE
 tolua_Error tolua_err;
 if (
...
#endif
 {
  ...
  {
   EmberOgre::Gui::Adapters::Ogre::ResourceListAdapter* tolua_ret = (EmberOgre::Gui::Adapters::Ogre::ResourceListAdapter*)  new EmberOgre::Gui::Adapters::Ogre::ResourceListAdapter(listHolder,resourceManager);
   tolua_pushusertype_and_takeownership(tolua_S,(void *)tolua_ret,"EmberOgre::Gui::Adapters::Ogre::ResourceListAdapter");
  }
 }
 return 1;
#ifndef TOLUA_RELEASE
...
/* method: delete of class  EmberOgre::Gui::Adapters::Ogre::ResourceListAdapter */
#ifndef TOLUA_DISABLE_tolua_EmberOgre_EmberOgre_Gui_Adapters_Ogre_ResourceListAdapter_delete00
static int tolua_EmberOgre_EmberOgre_Gui_Adapters_Ogre_ResourceListAdapter_delete00(lua_State* tolua_S)
{
#ifndef TOLUA_RELEASE
 tolua_Error tolua_err;
 if (
     !tolua_isusertype(tolua_S,1,"EmberOgre::Gui::Adapters::Ogre::ResourceListAdapter",0,&tolua_err) ||
     !tolua_isnoobj(tolua_S,2,&tolua_err)
 )
  goto tolua_lerror;
 else
...
/* method: update of class  EmberOgre::Gui::Adapters::Ogre::ResourceListAdapter */
#ifndef TOLUA_DISABLE_tolua_EmberOgre_EmberOgre_Gui_Adapters_Ogre_ResourceListAdapter_update00
static int tolua_EmberOgre_EmberOgre_Gui_Adapters_Ogre_ResourceListAdapter_update00(lua_State* tolua_S)
{
#ifndef TOLUA_RELEASE
 tolua_Error tolua_err;
 if (
...
#endif
  tolua_pushusertype(tolua_S,(void*)&self->EventPickedEntity,"sigc::signal<void,const std::vector<EmberOgre::EntityPickResult>&,const EmberOgre::MousePickerArgs&>");
 return 1;
}
#endif //#ifndef TOLUA_DISABLE
...
static int tolua_set_EmberOgre__EntityWorldPickListener_EventPickedEntity(lua_State* tolua_S)
{
  ...
  tolua_Error tolua_err;
  if (!self) tolua_error(tolua_S,"invalid 'self' in accessing variable 'EventPickedEntity'",NULL);
  if (!tolua_isusertype(tolua_S,2,"sigc::signal<void,const std::vector<EmberOgre::EntityPickResult>&,const EmberOgre::MousePickerArgs&>",0,&tolua_err))
   tolua_error(tolua_S,"#vinvalid type in variable assignment.",&tolua_err);
#endif
  self->EventPickedEntity = *((sigc::signal<void,const std::vector<EmberOgre::EntityPickResult>&,const EmberOgre::MousePickerArgs&>*)  tolua_tousertype(tolua_S,2,0))
;
 return 0;
}
#endif //#ifndef TOLUA_DISABLE
...
/* method: startMove of class  EmberOgre::Authoring::EntityMoveManager */
#ifndef TOLUA_DISABLE_tolua_EmberOgre_EmberOgre_Authoring_EntityMoveManager_startMove00
static int tolua_EmberOgre_EmberOgre_Authoring_EntityMoveManager_startMove00(lua_State* tolua_S)
{
#ifndef TOLUA_RELEASE
 tolua_Error tolua_err;
 if (
     !tolua_isusertype(tolua_S,1,"EmberOgre::Authoring::EntityMoveManager",0,&tolua_err) ||
     !tolua_isusertype(tolua_S,2,"EmberOgre::EmberEntity",0,&tolua_err) ||
     !tolua_isnoobj(tolua_S,3,&tolua_err)
 )
  goto tolua_lerror;
...
#endif
 {
  EmberOgre::Authoring::EntityMoveManager* self = (EmberOgre::Authoring::EntityMoveManager*)  tolua_tousertype(tolua_S,1,0);
  EmberOgre::EmberEntity* entity = ((EmberOgre::EmberEntity*)  tolua_tousertype(tolua_S,2,0));
#ifndef TOLUA_RELEASE
...
/* method: runCommand of class  EmberOgre::Authoring::EntityMoveManager */
#ifndef TOLUA_DISABLE_tolua_EmberOgre_EmberOgre_Authoring_EntityMoveManager_runCommand00
static int tolua_EmberOgre_EmberOgre_Authoring_EntityMoveManager_runCommand00(lua_State* tolua_S)
{
#ifndef TOLUA_RELEASE
 tolua_Error tolua_err;
 if (
...
/* get function: EventStartMoving of class  EmberOgre::Authoring::EntityMoveManager */
#ifndef TOLUA_DISABLE_tolua_get_EmberOgre__Authoring__EntityMoveManager_EventStartMoving
static int tolua_get_EmberOgre__Authoring__EntityMoveManager_EventStartMoving(lua_State* tolua_S)
{
  EmberOgre::Authoring::EntityMoveManager* self = (EmberOgre::Authoring::EntityMoveManager*)  tolua_tousertype(tolua_S,1,0);
#ifndef TOLUA_RELEASE
  if (!self) tolua_error(tolua_S,"invalid 'self' in accessing variable 'EventStartMoving'",NULL);
#endif
  tolua_pushusertype(tolua_S,(void*)&self->EventStartMoving,"sigc::signal<void,EmberOgre::EmberEntity&,EmberOgre::Authoring::EntityMover&>");
 return 1;
}
#endif //#ifndef TOLUA_DISABLE

/* set function: EventStartMoving of class  EmberOgre::Authoring::EntityMoveManager */
#ifndef TOLUA_DISABLE_tolua_set_EmberOgre__Authoring__EntityMoveManager_EventStartMoving
static int tolua_set_EmberOgre__Authoring__EntityMoveManager_EventStartMoving(lua_State* tolua_S)
{
  EmberOgre::Authoring::EntityMoveManager* self = (EmberOgre::Authoring::EntityMoveManager*)  tolua_tousertype(tolua_S,1,0);
#ifndef TOLUA_RELEASE
  tolua_Error tolua_err;
  if (!self) tolua_error(tolua_S,"invalid 'self' in accessing variable 'EventStartMoving'",NULL);
  if (!tolua_isusertype(tolua_S,2,"sigc::signal<void,EmberOgre::EmberEntity&,EmberOgre::Authoring::EntityMover&>",0,&tolua_err))
   tolua_error(tolua_S,"#vinvalid type in variable assignment.",&tolua_err);
#endif
  self->EventStartMoving = *((sigc::signal<void,EmberOgre::EmberEntity&,EmberOgre::Authoring::EntityMover&>*)  tolua_tousertype(tolua_S,2,0))
;
 return 0;
}
#endif //#ifndef TOLUA_DISABLE

/* get function: EventFinishedMoving of class  EmberOgre::Authoring::EntityMoveManager */
#ifndef TOLUA_DISABLE_tolua_get_EmberOgre__Authoring__EntityMoveManager_EventFinishedMoving
static int tolua_get_EmberOgre__Authoring__EntityMoveManager_EventFinishedMoving(lua_State* tolua_S)
{
  EmberOgre::Authoring::EntityMoveManager* self = (EmberOgre::Authoring::EntityMoveManager*)  tolua_tousertype(tolua_S,1,0);
#ifndef TOLUA_RELEASE
...
/* set function: EventFinishedMoving of class  EmberOgre::Authoring::EntityMoveManager */
#ifndef TOLUA_DISABLE_tolua_set_EmberOgre__Authoring__EntityMoveManager_EventFinishedMoving
static int tolua_set_EmberOgre__Authoring__EntityMoveManager_EventFinishedMoving(lua_State* tolua_S)
{
  EmberOgre::Authoring::EntityMoveManager* self = (EmberOgre::Authoring::EntityMoveManager*)  tolua_tousertype(tolua_S,1,0);
#ifndef TOLUA_RELEASE
  tolua_Error tolua_err;
...
/* get function: EventCancelledMoving of class  EmberOgre::Authoring::EntityMoveManager */
#ifndef TOLUA_DISABLE_tolua_get_EmberOgre__Authoring__EntityMoveManager_EventCancelledMoving
static int tolua_get_EmberOgre__Authoring__EntityMoveManager_EventCancelledMoving(lua_State* tolua_S)
{
  EmberOgre::Authoring::EntityMoveManager* self = (EmberOgre::Authoring::EntityMoveManager*)  tolua_tousertype(tolua_S,1,0);
#ifndef TOLUA_RELEASE
...
/* set function: EventCancelledMoving of class  EmberOgre::Authoring::EntityMoveManager */
#ifndef TOLUA_DISABLE_tolua_set_EmberOgre__Authoring__EntityMoveManager_EventCancelledMoving
static int tolua_set_EmberOgre__Authoring__EntityMoveManager_EventCancelledMoving(lua_State* tolua_S)
{
  EmberOgre::Authoring::EntityMoveManager* self = (EmberOgre::Authoring::EntityMoveManager*)  tolua_tousertype(tolua_S,1,0);
#ifndef TOLUA_RELEASE
  tolua_Error tolua_err;
...
/* method: new of class  EmberOgre::Authoring::GUIAdapter */
#ifndef TOLUA_DISABLE_tolua_EmberOgre_EmberOgre_Authoring_GUIAdapter_new00
static int tolua_EmberOgre_EmberOgre_Authoring_GUIAdapter_new00(lua_State* tolua_S)
{
#ifndef TOLUA_RELEASE
 tolua_Error tolua_err;
 if (
     !tolua_isusertable(tolua_S,1,"EmberOgre::Authoring::GUIAdapter",0,&tolua_err) ||
     !tolua_iscppstring(tolua_S,2,0,&tolua_err) ||
     !tolua_isnoobj(tolua_S,3,&tolua_err)
 )
  goto tolua_lerror;
...
#endif
 {
  ...
  {
   EmberOgre::Authoring::GUIAdapter* tolua_ret = (EmberOgre::Authoring::GUIAdapter*)  new EmberOgre::Authoring::GUIAdapter(type);
   tolua_pushusertype(tolua_S,(void*)tolua_ret,"EmberOgre::Authoring::GUIAdapter");
...
/* method: new_local of class  EmberOgre::Authoring::GUIAdapter */
#ifndef TOLUA_DISABLE_tolua_EmberOgre_EmberOgre_Authoring_GUIAdapter_new00_local
static int tolua_EmberOgre_EmberOgre_Authoring_GUIAdapter_new00_local(lua_State* tolua_S)
{
#ifndef TOLUA_RELEASE
 tolua_Error tolua_err;
 if (
...
#endif
 {
  ...
  {
   EmberOgre::Authoring::GUIAdapter* tolua_ret = (EmberOgre::Authoring::GUIAdapter*)  new EmberOgre::Authoring::GUIAdapter(type);
   tolua_pushusertype_and_takeownership(tolua_S,(void *)tolua_ret,"EmberOgre::Authoring::GUIAdapter");
   tolua_pushcppstring(tolua_S,(const char*)type);
  }
 }
 return 2;
...
/* method: delete of class  EmberOgre::Authoring::GUIAdapter */
#ifndef TOLUA_DISABLE_tolua_EmberOgre_EmberOgre_Authoring_GUIAdapter_delete00
static int tolua_EmberOgre_EmberOgre_Authoring_GUIAdapter_delete00(lua_State* tolua_S)
{
#ifndef TOLUA_RELEASE
 tolua_Error tolua_err;
 if (
     !tolua_isusertype(tolua_S,1,"EmberOgre::Authoring::GUIAdapter",0,&tolua_err) ||
     !tolua_isnoobj(tolua_S,2,&tolua_err)
 )
  goto tolua_lerror;
 else
...
/* method: getType of class  EmberOgre::Authoring::GUIAdapter */
#ifndef TOLUA_DISABLE_tolua_EmberOgre_EmberOgre_Authoring_GUIAdapter_getType00
static int tolua_EmberOgre_EmberOgre_Authoring_GUIAdapter_getType00(lua_State* tolua_S)
{
#ifndef TOLUA_RELEASE
 tolua_Error tolua_err;
 if (
     !tolua_isusertype(tolua_S,1,"const EmberOgre::Authoring::GUIAdapter",0,&tolua_err) ||
     !tolua_isnoobj(tolua_S,2,&tolua_err)
 )
  goto tolua_lerror;
 else
#endif
 {
  const EmberOgre::Authoring::GUIAdapter* self = (const EmberOgre::Authoring::GUIAdapter*)  tolua_tousertype(tolua_S,1,0);
#ifndef TOLUA_RELEASE
  if (!self) tolua_error(tolua_S,"invalid 'self' in function 'getType'",NULL);
#endif
  {
...
/* method: attach of class  EmberOgre::Authoring::GUIAdapter */
#ifndef TOLUA_DISABLE_tolua_EmberOgre_EmberOgre_Authoring_GUIAdapter_attach00
static int tolua_EmberOgre_EmberOgre_Authoring_GUIAdapter_attach00(lua_State* tolua_S)
{
#ifndef TOLUA_RELEASE
 tolua_Error tolua_err;
 if (
...
/* method: detach of class  EmberOgre::Authoring::GUIAdapter */
#ifndef TOLUA_DISABLE_tolua_EmberOgre_EmberOgre_Authoring_GUIAdapter_detach00
static int tolua_EmberOgre_EmberOgre_Authoring_GUIAdapter_detach00(lua_State* tolua_S)
{
#ifndef TOLUA_RELEASE
 tolua_Error tolua_err;
 if (
...
/* method: getValue of class  EmberOgre::Authoring::GUIAdapter */
#ifndef TOLUA_DISABLE_tolua_EmberOgre_EmberOgre_Authoring_GUIAdapter_getValue00
static int tolua_EmberOgre_EmberOgre_Authoring_GUIAdapter_getValue00(lua_State* tolua_S)
{
#ifndef TOLUA_RELEASE
 tolua_Error tolua_err;
 if (
...
/* method: setTitle of class  EmberOgre::Authoring::GUIAdapter */
#ifndef TOLUA_DISABLE_tolua_EmberOgre_EmberOgre_Authoring_GUIAdapter_setTitle00
static int tolua_EmberOgre_EmberOgre_Authoring_GUIAdapter_setTitle00(lua_State* tolua_S)
{
#ifndef TOLUA_RELEASE
 tolua_Error tolua_err;
 if (
...
/* method: getTitle of class  EmberOgre::Authoring::GUIAdapter */
#ifndef TOLUA_DISABLE_tolua_EmberOgre_EmberOgre_Authoring_GUIAdapter_getTitle00
static int tolua_EmberOgre_EmberOgre_Authoring_GUIAdapter_getTitle00(lua_State* tolua_S)
{
#ifndef TOLUA_RELEASE
 tolua_Error tolua_err;
 if (
...
/* method: setTooltip of class  EmberOgre::Authoring::GUIAdapter */
#ifndef TOLUA_DISABLE_tolua_EmberOgre_EmberOgre_Authoring_GUIAdapter_setTooltip00
static int tolua_EmberOgre_EmberOgre_Authoring_GUIAdapter_setTooltip00(lua_State* tolua_S)
{
#ifndef TOLUA_RELEASE
 tolua_Error tolua_err;
 if (
...
/* method: getTooltip of class  EmberOgre::Authoring::GUIAdapter */
#ifndef TOLUA_DISABLE_tolua_EmberOgre_EmberOgre_Authoring_GUIAdapter_getTooltip00
static int tolua_EmberOgre_EmberOgre_Authoring_GUIAdapter_getTooltip00(lua_State* tolua_S)
{
#ifndef TOLUA_RELEASE
 tolua_Error tolua_err;
 if (
...
/* method: addSuggestion of class  EmberOgre::Authoring::GUIAdapter */
#ifndef TOLUA_DISABLE_tolua_EmberOgre_EmberOgre_Authoring_GUIAdapter_addSuggestion00
static int tolua_EmberOgre_EmberOgre_Authoring_GUIAdapter_addSuggestion00(lua_State* tolua_S)
{
#ifndef TOLUA_RELEASE
 tolua_Error tolua_err;
 if (
...
/* method: new of class  EmberOgre::Authoring::EntityRecipe */
#ifndef TOLUA_DISABLE_tolua_EmberOgre_EmberOgre_Authoring_EntityRecipe_new00
static int tolua_EmberOgre_EmberOgre_Authoring_EntityRecipe_new00(lua_State* tolua_S)
{
#ifndef TOLUA_RELEASE
 tolua_Error tolua_err;
 if (
     !tolua_isusertable(tolua_S,1,"EmberOgre::Authoring::EntityRecipe",0,&tolua_err) ||
...
#endif
 {
  ...
  {
   EmberOgre::Authoring::EntityRecipe* tolua_ret = (EmberOgre::Authoring::EntityRecipe*)  new EmberOgre::Authoring::EntityRecipe(creator,*name,handle,*group,isManual,loader);
   tolua_pushusertype(tolua_S,(void*)tolua_ret,"EmberOgre::Authoring::EntityRecipe");
  }
 }
 return 1;
#ifndef TOLUA_RELEASE
...
/* method: new_local of class  EmberOgre::Authoring::EntityRecipe */
#ifndef TOLUA_DISABLE_tolua_EmberOgre_EmberOgre_Authoring_EntityRecipe_new00_local
static int tolua_EmberOgre_EmberOgre_Authoring_EntityRecipe_new00_local(lua_State* tolua_S)
{
#ifndef TOLUA_RELEASE
 tolua_Error tolua_err;
 if (
...
#endif
 {
  ...
  {
   EmberOgre::Authoring::EntityRecipe* tolua_ret = (EmberOgre::Authoring::EntityRecipe*)  new EmberOgre::Authoring::EntityRecipe(creator,*name,handle,*group,isManual,loader);
   tolua_pushusertype_and_takeownership(tolua_S,(void *)tolua_ret,"EmberOgre::Authoring::EntityRecipe");
  }
 }
 return 1;
#ifndef TOLUA_RELEASE
...
/* method: delete of class  EmberOgre::Authoring::EntityRecipe */
#ifndef TOLUA_DISABLE_tolua_EmberOgre_EmberOgre_Authoring_EntityRecipe_delete00
static int tolua_EmberOgre_EmberOgre_Authoring_EntityRecipe_delete00(lua_State* tolua_S)
{
#ifndef TOLUA_RELEASE
 tolua_Error tolua_err;
 if (
     !tolua_isusertype(tolua_S,1,"EmberOgre::Authoring::EntityRecipe",0,&tolua_err) ||
     !tolua_isnoobj(tolua_S,2,&tolua_err)
 )
  goto tolua_lerror;
 else
...
/* method: loadImpl of class  EmberOgre::Authoring::EntityRecipe */
#ifndef TOLUA_DISABLE_tolua_EmberOgre_EmberOgre_Authoring_EntityRecipe_loadImpl00
static int tolua_EmberOgre_EmberOgre_Authoring_EntityRecipe_loadImpl00(lua_State* tolua_S)
{
#ifndef TOLUA_RELEASE
 tolua_Error tolua_err;
 if (
...
/* method: unloadImpl of class  EmberOgre::Authoring::EntityRecipe */
#ifndef TOLUA_DISABLE_tolua_EmberOgre_EmberOgre_Authoring_EntityRecipe_unloadImpl00
static int tolua_EmberOgre_EmberOgre_Authoring_EntityRecipe_unloadImpl00(lua_State* tolua_S)
{
#ifndef TOLUA_RELEASE
 tolua_Error tolua_err;
 if (
...
/* method: calculateSize of class  EmberOgre::Authoring::EntityRecipe */
#ifndef TOLUA_DISABLE_tolua_EmberOgre_EmberOgre_Authoring_EntityRecipe_calculateSize00
static int tolua_EmberOgre_EmberOgre_Authoring_EntityRecipe_calculateSize00(lua_State* tolua_S)
{
#ifndef TOLUA_RELEASE
 tolua_Error tolua_err;
 if (
     !tolua_isusertype(tolua_S,1,"const EmberOgre::Authoring::EntityRecipe",0,&tolua_err) ||
     !tolua_isnoobj(tolua_S,2,&tolua_err)
 )
  goto tolua_lerror;
 else
#endif
 {
  const EmberOgre::Authoring::EntityRecipe* self = (const EmberOgre::Authoring::EntityRecipe*)  tolua_tousertype(tolua_S,1,0);
#ifndef TOLUA_RELEASE
...
/* method: getGUIAdapters of class  EmberOgre::Authoring::EntityRecipe */
#ifndef TOLUA_DISABLE_tolua_EmberOgre_EmberOgre_Authoring_EntityRecipe_getGUIAdapters00
static int tolua_EmberOgre_EmberOgre_Authoring_EntityRecipe_getGUIAdapters00(lua_State* tolua_S)
{
#ifndef TOLUA_RELEASE
 tolua_Error tolua_err;
 if (
...
#endif
  {
   const EmberOgre::Authoring::GUIAdaptersStore& tolua_ret = (const EmberOgre::Authoring::GUIAdaptersStore&)  self->getGUIAdapters();
   tolua_pushusertype(tolua_S,(void*)&tolua_ret,"const EmberOgre::Authoring::GUIAdaptersStore");
  }
 }
 return 1;
#ifndef TOLUA_RELEASE
...
/* method: setAuthor of class  EmberOgre::Authoring::EntityRecipe */
#ifndef TOLUA_DISABLE_tolua_EmberOgre_EmberOgre_Authoring_EntityRecipe_setAuthor00
static int tolua_EmberOgre_EmberOgre_Authoring_EntityRecipe_setAuthor00(lua_State* tolua_S)
{
#ifndef TOLUA_RELEASE
 tolua_Error tolua_err;
 if (
...
/* method: getAuthor of class  EmberOgre::Authoring::EntityRecipe */
#ifndef TOLUA_DISABLE_tolua_EmberOgre_EmberOgre_Authoring_EntityRecipe_getAuthor00
static int tolua_EmberOgre_EmberOgre_Authoring_EntityRecipe_getAuthor00(lua_State* tolua_S)
{
#ifndef TOLUA_RELEASE
 tolua_Error tolua_err;
 if (
...
/* method: setDescription of class  EmberOgre::Authoring::EntityRecipe */
#ifndef TOLUA_DISABLE_tolua_EmberOgre_EmberOgre_Authoring_EntityRecipe_setDescription00
static int tolua_EmberOgre_EmberOgre_Authoring_EntityRecipe_setDescription00(lua_State* tolua_S)
{
#ifndef TOLUA_RELEASE
 tolua_Error tolua_err;
 if (
...
/* method: getDescription of class  EmberOgre::Authoring::EntityRecipe */
#ifndef TOLUA_DISABLE_tolua_EmberOgre_EmberOgre_Authoring_EntityRecipe_getDescription00
static int tolua_EmberOgre_EmberOgre_Authoring_EntityRecipe_getDescription00(lua_State* tolua_S)
{
#ifndef TOLUA_RELEASE
 tolua_Error tolua_err;
 if (
...
/* method: createEntity of class  EmberOgre::Authoring::EntityRecipe */
#ifndef TOLUA_DISABLE_tolua_EmberOgre_EmberOgre_Authoring_EntityRecipe_createEntity00
static int tolua_EmberOgre_EmberOgre_Authoring_EntityRecipe_createEntity00(lua_State* tolua_S)
{
#ifndef TOLUA_RELEASE
 tolua_Error tolua_err;
 if (
...
/* method: get of class  EmberOgre::Authoring::EntityRecipePtr */
#ifndef TOLUA_DISABLE_tolua_EmberOgre_EmberOgre_Authoring_EntityRecipePtr_get00
static int tolua_EmberOgre_EmberOgre_Authoring_EntityRecipePtr_get00(lua_State* tolua_S)
{
#ifndef TOLUA_RELEASE
 tolua_Error tolua_err;
 if (
     !tolua_isusertype(tolua_S,1,"EmberOgre::Authoring::EntityRecipePtr",0,&tolua_err) ||
     !tolua_isnoobj(tolua_S,2,&tolua_err)
 )
  goto tolua_lerror;
 else
#endif
 {
  EmberOgre::Authoring::EntityRecipePtr* self = (EmberOgre::Authoring::EntityRecipePtr*)  tolua_tousertype(tolua_S,1,0);
#ifndef TOLUA_RELEASE
  if (!self) tolua_error(tolua_S,"invalid 'self' in function 'get'",NULL);
#endif
  {
   EmberOgre::Authoring::EntityRecipe* tolua_ret = (EmberOgre::Authoring::EntityRecipe*)  self->get();
   tolua_pushusertype(tolua_S,(void*)tolua_ret,"EmberOgre::Authoring::EntityRecipe");
  }
 }
 return 1;
...
#ifndef TOLUA_DISABLE_tolua_get_EmberOgre__Authoring__GUIAdaptersStore__value_type_first
static int tolua_get_EmberOgre__Authoring__GUIAdaptersStore__value_type_first(lua_State* tolua_S)
{
  EmberOgre::Authoring::GUIAdaptersStore::value_type* self = (EmberOgre::Authoring::GUIAdaptersStore::value_type*)  tolua_tousertype(tolua_S,1,0);
#ifndef TOLUA_RELEASE
...
#ifndef TOLUA_DISABLE_tolua_get_EmberOgre__Authoring__GUIAdaptersStore__value_type_second_ptr
static int tolua_get_EmberOgre__Authoring__GUIAdaptersStore__value_type_second_ptr(lua_State* tolua_S)
{
  EmberOgre::Authoring::GUIAdaptersStore::value_type* self = (EmberOgre::Authoring::GUIAdaptersStore::value_type*)  tolua_tousertype(tolua_S,1,0);
#ifndef TOLUA_RELEASE
  if (!self) tolua_error(tolua_S,"invalid 'self' in accessing variable 'second'",NULL);
#endif
  tolua_pushusertype(tolua_S,(void*)self->second,"EmberOgre::Authoring::GUIAdapter");
 return 1;
}
#endif //#ifndef TOLUA_DISABLE

/* set function: second of class  value_type */
#ifndef TOLUA_DISABLE_tolua_set_EmberOgre__Authoring__GUIAdaptersStore__value_type_second_ptr
static int tolua_set_EmberOgre__Authoring__GUIAdaptersStore__value_type_second_ptr(lua_State* tolua_S)
{
  EmberOgre::Authoring::GUIAdaptersStore::value_type* self = (EmberOgre::Authoring::GUIAdaptersStore::value_type*)  tolua_tousertype(tolua_S,1,0);
#ifndef TOLUA_RELEASE
  tolua_Error tolua_err;
  if (!self) tolua_error(tolua_S,"invalid 'self' in accessing variable 'second'",NULL);
  if (!tolua_isusertype(tolua_S,2,"EmberOgre::Authoring::GUIAdapter",0,&tolua_err))
   tolua_error(tolua_S,"#vinvalid type in variable assignment.",&tolua_err);
#endif
  self->second = ((EmberOgre::Authoring::GUIAdapter*)  tolua_tousertype(tolua_S,2,0))
;
 return 0;
}
#endif //#ifndef TOLUA_DISABLE
...
#ifndef TOLUA_DISABLE_tolua_EmberOgre_EmberOgre_Authoring_GUIAdaptersStore_const_iterator_get00
static int tolua_EmberOgre_EmberOgre_Authoring_GUIAdaptersStore_const_iterator_get00(lua_State* tolua_S)
{
#ifndef TOLUA_RELEASE
 tolua_Error tolua_err;
 if (
     !tolua_isusertype(tolua_S,1,"EmberOgre::Authoring::GUIAdaptersStore::const_iterator",0,&tolua_err) ||
     !tolua_isnoobj(tolua_S,2,&tolua_err)
 )
  goto tolua_lerror;
 else
...
#endif
  {
   EmberOgre::Authoring::GUIAdaptersStore::value_type& tolua_ret = (EmberOgre::Authoring::GUIAdaptersStore::value_type&)  self->__operator_ptr();
   tolua_pushusertype(tolua_S,(void*)&tolua_ret,"EmberOgre::Authoring::GUIAdaptersStore::value_type");
  }
 }
 return 1;
#ifndef TOLUA_RELEASE
...
#ifndef TOLUA_DISABLE_tolua_EmberOgre_EmberOgre_Authoring_GUIAdaptersStore_const_iterator_next00
static int tolua_EmberOgre_EmberOgre_Authoring_GUIAdaptersStore_const_iterator_next00(lua_State* tolua_S)
{
#ifndef TOLUA_RELEASE
 tolua_Error tolua_err;
 if (
...
#endif
  {
   EmberOgre::Authoring::GUIAdaptersStore::const_iterator& tolua_ret = (EmberOgre::Authoring::GUIAdaptersStore::const_iterator&)  self->__operator_pp();
   tolua_pushusertype(tolua_S,(void*)&tolua_ret,"EmberOgre::Authoring::GUIAdaptersStore::const_iterator");
  }
 }
 return 1;
#ifndef TOLUA_RELEASE
...
#ifndef TOLUA_DISABLE_tolua_EmberOgre_EmberOgre_Authoring_GUIAdaptersStore_const_iterator__eq00
static int tolua_EmberOgre_EmberOgre_Authoring_GUIAdaptersStore_const_iterator__eq00(lua_State* tolua_S)
{
#ifndef TOLUA_RELEASE
 tolua_Error tolua_err;
 if (
     !tolua_isusertype(tolua_S,1,"EmberOgre::Authoring::GUIAdaptersStore::const_iterator",0,&tolua_err) ||
     !tolua_isusertype(tolua_S,2,"const EmberOgre::Authoring::GUIAdaptersStore::const_iterator",0,&tolua_err) ||
     !tolua_isnoobj(tolua_S,3,&tolua_err)
 )
  goto tolua_lerror;
 else
 ...
 {
  EmberOgre::Authoring::GUIAdaptersStore::const_iterator* self = (EmberOgre::Authoring::GUIAdaptersStore::const_iterator*)  tolua_tousertype(tolua_S,1,0);
  const EmberOgre::Authoring::GUIAdaptersStore::const_iterator* value = ((const EmberOgre::Authoring::GUIAdaptersStore::const_iterator*)  tolua_tousertype(tolua_S,2,0));
#ifndef TOLUA_RELEASE
  if (!self) tolua_error(tolua_S,"invalid 'self' in function 'operator=='",NULL);
#endif
  {
...
/* method: begin of class  EmberOgre::Authoring::GUIAdaptersStore */
#ifndef TOLUA_DISABLE_tolua_EmberOgre_EmberOgre_Authoring_GUIAdaptersStore_begin00
static int tolua_EmberOgre_EmberOgre_Authoring_GUIAdaptersStore_begin00(lua_State* tolua_S)
{
#ifndef TOLUA_RELEASE
 tolua_Error tolua_err;
 if (
     !tolua_isusertype(tolua_S,1,"const EmberOgre::Authoring::GUIAdaptersStore",0,&tolua_err) ||
     !tolua_isnoobj(tolua_S,2,&tolua_err)
 )
  goto tolua_lerror;
 else
#endif
 {
  const EmberOgre::Authoring::GUIAdaptersStore* self = (const EmberOgre::Authoring::GUIAdaptersStore*)  tolua_tousertype(tolua_S,1,0);
#ifndef TOLUA_RELEASE
  if (!self) tolua_error(tolua_S,"invalid 'self' in function 'begin'",NULL);
#endif
  {
   EmberOgre::Authoring::GUIAdaptersStore::const_iterator tolua_ret = (EmberOgre::Authoring::GUIAdaptersStore::const_iterator)  self->begin();
   {
#ifdef __cplusplus
    void* tolua_obj = new EmberOgre::Authoring::GUIAdaptersStore::const_iterator(tolua_ret);
    tolua_pushusertype_and_takeownership(tolua_S,tolua_obj,"EmberOgre::Authoring::GUIAdaptersStore::const_iterator");
#else
    void* tolua_obj = tolua_copy(tolua_S,(void*)&tolua_ret,sizeof(EmberOgre::Authoring::GUIAdaptersStore::const_iterator));
    tolua_pushusertype_and_takeownership(tolua_S,tolua_obj,"EmberOgre::Authoring::GUIAdaptersStore::const_iterator");
#endif
   }
  }
...
/* method: end of class  EmberOgre::Authoring::GUIAdaptersStore */
#ifndef TOLUA_DISABLE_tolua_EmberOgre_EmberOgre_Authoring_GUIAdaptersStore_theEnd00
static int tolua_EmberOgre_EmberOgre_Authoring_GUIAdaptersStore_theEnd00(lua_State* tolua_S)
{
#ifndef TOLUA_RELEASE
 tolua_Error tolua_err;
 if (
...
#endif
  {
   EmberOgre::Authoring::GUIAdaptersStore::const_iterator tolua_ret = (EmberOgre::Authoring::GUIAdaptersStore::const_iterator)  self->end();
   {
#ifdef __cplusplus
    void* tolua_obj = new EmberOgre::Authoring::GUIAdaptersStore::const_iterator(tolua_ret);
    tolua_pushusertype_and_takeownership(tolua_S,tolua_obj,"EmberOgre::Authoring::GUIAdaptersStore::const_iterator");
...
/* method: getSingleton of class  EmberOgre::Authoring::EntityRecipeManager */
#ifndef TOLUA_DISABLE_tolua_EmberOgre_EmberOgre_Authoring_EntityRecipeManager_getSingleton00
static int tolua_EmberOgre_EmberOgre_Authoring_EntityRecipeManager_getSingleton00(lua_State* tolua_S)
{
#ifndef TOLUA_RELEASE
 tolua_Error tolua_err;
 if (
     !tolua_isusertable(tolua_S,1,"EmberOgre::Authoring::EntityRecipeManager",0,&tolua_err) ||
     !tolua_isnoobj(tolua_S,2,&tolua_err)
 )
  goto tolua_lerror;
 else
 ...
 {
  {
   EmberOgre::Authoring::EntityRecipeManager& tolua_ret = (EmberOgre::Authoring::EntityRecipeManager&)  EmberOgre::Authoring::EntityRecipeManager::getSingleton();
   tolua_pushusertype(tolua_S,(void*)&tolua_ret,"EmberOgre::Authoring::EntityRecipeManager");
  }
 }
 return 1;
#ifndef TOLUA_RELEASE
...
/* method: new of class  EmberOgre::Authoring::EntityRecipeManager */
#ifndef TOLUA_DISABLE_tolua_EmberOgre_EmberOgre_Authoring_EntityRecipeManager_new00
static int tolua_EmberOgre_EmberOgre_Authoring_EntityRecipeManager_new00(lua_State* tolua_S)
{
#ifndef TOLUA_RELEASE
 tolua_Error tolua_err;
 if (
 ...
 {
  {
   EmberOgre::Authoring::EntityRecipeManager* tolua_ret = (EmberOgre::Authoring::EntityRecipeManager*)  new EmberOgre::Authoring::EntityRecipeManager();
   tolua_pushusertype(tolua_S,(void*)tolua_ret,"EmberOgre::Authoring::EntityRecipeManager");
  }
 }
 return 1;
...
/* method: new_local of class  EmberOgre::Authoring::EntityRecipeManager */
#ifndef TOLUA_DISABLE_tolua_EmberOgre_EmberOgre_Authoring_EntityRecipeManager_new00_local
static int tolua_EmberOgre_EmberOgre_Authoring_EntityRecipeManager_new00_local(lua_State* tolua_S)
{
#ifndef TOLUA_RELEASE
 tolua_Error tolua_err;
 if (
...
#endif
 {
  {
   EmberOgre::Authoring::EntityRecipeManager* tolua_ret = (EmberOgre::Authoring::EntityRecipeManager*)  new EmberOgre::Authoring::EntityRecipeManager();
   tolua_pushusertype_and_takeownership(tolua_S,(void *)tolua_ret,"EmberOgre::Authoring::EntityRecipeManager");
  }
 }
 return 1;
#ifndef TOLUA_RELEASE
...
/* method: delete of class  EmberOgre::Authoring::EntityRecipeManager */
#ifndef TOLUA_DISABLE_tolua_EmberOgre_EmberOgre_Authoring_EntityRecipeManager_delete00
static int tolua_EmberOgre_EmberOgre_Authoring_EntityRecipeManager_delete00(lua_State* tolua_S)
{
#ifndef TOLUA_RELEASE
 tolua_Error tolua_err;
 if (
     !tolua_isusertype(tolua_S,1,"EmberOgre::Authoring::EntityRecipeManager",0,&tolua_err) ||
     !tolua_isnoobj(tolua_S,2,&tolua_err)
 )
  goto tolua_lerror;
 else
...
/* method: create of class  EmberOgre::Authoring::EntityRecipeManager */
#ifndef TOLUA_DISABLE_tolua_EmberOgre_EmberOgre_Authoring_EntityRecipeManager_create00
static int tolua_EmberOgre_EmberOgre_Authoring_EntityRecipeManager_create00(lua_State* tolua_S)
{
#ifndef TOLUA_RELEASE
 tolua_Error tolua_err;
 if (
...
/* method: parseScript of class  EmberOgre::Authoring::EntityRecipeManager */
#ifndef TOLUA_DISABLE_tolua_EmberOgre_EmberOgre_Authoring_EntityRecipeManager_parseScript00
static int tolua_EmberOgre_EmberOgre_Authoring_EntityRecipeManager_parseScript00(lua_State* tolua_S)
{
#ifndef TOLUA_RELEASE
 tolua_Error tolua_err;
 if (
...
/* get function: __Ember of class  EmberOgre::Authoring::EntityRecipeManager */
#ifndef TOLUA_DISABLE_tolua_get_EmberOgre__Authoring__EntityRecipeManager___Ember__Singleton_EntityRecipeManager___
static int tolua_get_EmberOgre__Authoring__EntityRecipeManager___Ember__Singleton_EntityRecipeManager___(lua_State* tolua_S)
{
  EmberOgre::Authoring::EntityRecipeManager* self = (EmberOgre::Authoring::EntityRecipeManager*)  tolua_tousertype(tolua_S,1,0);
#ifndef TOLUA_RELEASE
...
#endif
#ifdef __cplusplus
  tolua_pushusertype(tolua_S,(void*)static_cast<Ember::Singleton<EmberOgre::Authoring::EntityRecipeManager>*>(self), "Ember::Singleton<EmberOgre::Authoring::EntityRecipeManager>");
#else
  tolua_pushusertype(tolua_S,(void*)((Ember::Singleton<EmberOgre::Authoring::EntityRecipeManager>*)self), "Ember::Singleton<EmberOgre::Authoring::EntityRecipeManager>");
#endif
 return 1;
}
#endif //#ifndef TOLUA_DISABLE
...
static int tolua_EmberOgre_EmberOgre_Gui_EntityCreator_new00(lua_State* tolua_S)
{
 ...
 if (
     ...
     !tolua_isusertype(tolua_S,2,"Eris::Connection",0,&tolua_err) ||
     !tolua_isnoobj(tolua_S,3,&tolua_err)
 )
  goto tolua_lerror;
 else
#endif
 {
  Eris::Connection* conn = ((Eris::Connection*)  tolua_tousertype(tolua_S,2,0));
  {
   EmberOgre::Gui::EntityCreator* tolua_ret = (EmberOgre::Gui::EntityCreator*)  new EmberOgre::Gui::EntityCreator(*conn);
...
static int tolua_EmberOgre_EmberOgre_Gui_EntityCreator_setRecipe00(lua_State* tolua_S)
{
 ...
 if (
     !tolua_isusertype(tolua_S,1,"EmberOgre::Gui::EntityCreator",0,&tolua_err) ||
     !tolua_isusertype(tolua_S,2,"EmberOgre::Authoring::EntityRecipe",0,&tolua_err) ||
     !tolua_isnoobj(tolua_S,3,&tolua_err)
 )
  goto tolua_lerror;
 else
 ...
 {
  EmberOgre::Gui::EntityCreator* self = (EmberOgre::Gui::EntityCreator*)  tolua_tousertype(tolua_S,1,0);
  EmberOgre::Authoring::EntityRecipe* recipe = ((EmberOgre::Authoring::EntityRecipe*)  tolua_tousertype(tolua_S,2,0));
#ifndef TOLUA_RELEASE
...
/* method: displayAuthoringVisualization of class  EmberOgre::Authoring::AuthoringManager */
#ifndef TOLUA_DISABLE_tolua_EmberOgre_EmberOgre_Authoring_AuthoringManager_displayAuthoringVisualization00
static int tolua_EmberOgre_EmberOgre_Authoring_AuthoringManager_displayAuthoringVisualization00(lua_State* tolua_S)
{
#ifndef TOLUA_RELEASE
 tolua_Error tolua_err;
 if (
     !tolua_isusertype(tolua_S,1,"EmberOgre::Authoring::AuthoringManager",0,&tolua_err) ||
     !tolua_isnoobj(tolua_S,2,&tolua_err)
 )
  goto tolua_lerror;
 else
#endif
 {
  EmberOgre::Authoring::AuthoringManager* self = (EmberOgre::Authoring::AuthoringManager*)  tolua_tousertype(tolua_S,1,0);
#ifndef TOLUA_RELEASE
  if (!self) tolua_error(tolua_S,"invalid 'self' in function 'displayAuthoringVisualization'",NULL);
#endif
  {
   self->displayAuthoringVisualization();
  }
 }
 return 0;
#ifndef TOLUA_RELEASE
 tolua_lerror:
 tolua_error(tolua_S,"#ferror in function 'displayAuthoringVisualization'.",&tolua_err);
 return 0;
#endif
}
#endif //#ifndef TOLUA_DISABLE

/* method: hideAuthoringVisualization of class  EmberOgre::Authoring::AuthoringManager */
#ifndef TOLUA_DISABLE_tolua_EmberOgre_EmberOgre_Authoring_AuthoringManager_hideAuthoringVisualization00
static int tolua_EmberOgre_EmberOgre_Authoring_AuthoringManager_hideAuthoringVisualization00(lua_State* tolua_S)
{
#ifndef TOLUA_RELEASE
 tolua_Error tolua_err;
 if (
...
#endif
 {
  EmberOgre::Authoring::AuthoringManager* self = (EmberOgre::Authoring::AuthoringManager*)  tolua_tousertype(tolua_S,1,0);
#ifndef TOLUA_RELEASE
  if (!self) tolua_error(tolua_S,"invalid 'self' in function 'hideAuthoringVisualization'",NULL);
#endif
  {
   self->hideAuthoringVisualization();
  }
 }
 return 0;
#ifndef TOLUA_RELEASE
 tolua_lerror:
 tolua_error(tolua_S,"#ferror in function 'hideAuthoringVisualization'.",&tolua_err);
 return 0;
#endif
}
#endif //#ifndef TOLUA_DISABLE

/* method: startMovement of class  EmberOgre::Authoring::AuthoringManager */
#ifndef TOLUA_DISABLE_tolua_EmberOgre_EmberOgre_Authoring_AuthoringManager_startMovement00
static int tolua_EmberOgre_EmberOgre_Authoring_AuthoringManager_startMovement00(lua_State* tolua_S)
{
#ifndef TOLUA_RELEASE
 tolua_Error tolua_err;
 if (
     !tolua_isusertype(tolua_S,1,"EmberOgre::Authoring::AuthoringManager",0,&tolua_err) ||
     !tolua_isusertype(tolua_S,2,"EmberOgre::EmberEntity",0,&tolua_err) ||
     !tolua_isusertype(tolua_S,3,"EmberOgre::Authoring::EntityMover",0,&tolua_err) ||
     !tolua_isnoobj(tolua_S,4,&tolua_err)
 )
  goto tolua_lerror;
 else
#endif
 {
  EmberOgre::Authoring::AuthoringManager* self = (EmberOgre::Authoring::AuthoringManager*)  tolua_tousertype(tolua_S,1,0);
  EmberOgre::EmberEntity* entity = ((EmberOgre::EmberEntity*)  tolua_tousertype(tolua_S,2,0));
  EmberOgre::Authoring::EntityMover* mover = ((EmberOgre::Authoring::EntityMover*)  tolua_tousertype(tolua_S,3,0));
#ifndef TOLUA_RELEASE
  if (!self) tolua_error(tolua_S,"invalid 'self' in function 'startMovement'",NULL);
#endif
  {
   self->startMovement(*entity,*mover);
  }
 }
 return 0;
#ifndef TOLUA_RELEASE
 tolua_lerror:
 tolua_error(tolua_S,"#ferror in function 'startMovement'.",&tolua_err);
 return 0;
#endif
}
#endif //#ifndef TOLUA_DISABLE

/* method: stopMovement of class  EmberOgre::Authoring::AuthoringManager */
#ifndef TOLUA_DISABLE_tolua_EmberOgre_EmberOgre_Authoring_AuthoringManager_stopMovement00
static int tolua_EmberOgre_EmberOgre_Authoring_AuthoringManager_stopMovement00(lua_State* tolua_S)
{
#ifndef TOLUA_RELEASE
 tolua_Error tolua_err;
 if (
...
#endif
 {
  EmberOgre::Authoring::AuthoringManager* self = (EmberOgre::Authoring::AuthoringManager*)  tolua_tousertype(tolua_S,1,0);
#ifndef TOLUA_RELEASE
  if (!self) tolua_error(tolua_S,"invalid 'self' in function 'stopMovement'",NULL);
#endif
  {
   self->stopMovement();
  }
...
#ifndef TOLUA_RELEASE
 tolua_lerror:
 tolua_error(tolua_S,"#ferror in function 'stopMovement'.",&tolua_err);
 return 0;
#endif
}
#endif //#ifndef TOLUA_DISABLE

/* method: getRawTypeInfoRepository of class  EmberOgre::Authoring::AuthoringManager */
#ifndef TOLUA_DISABLE_tolua_EmberOgre_EmberOgre_Authoring_AuthoringManager_getRawTypeInfoRepository00
static int tolua_EmberOgre_EmberOgre_Authoring_AuthoringManager_getRawTypeInfoRepository00(lua_State* tolua_S)
{
#ifndef TOLUA_RELEASE
 tolua_Error tolua_err;
 if (
     !tolua_isusertype(tolua_S,1,"const EmberOgre::Authoring::AuthoringManager",0,&tolua_err) ||
     !tolua_isnoobj(tolua_S,2,&tolua_err)
 )
  goto tolua_lerror;
 else
#endif
 {
  const EmberOgre::Authoring::AuthoringManager* self = (const EmberOgre::Authoring::AuthoringManager*)  tolua_tousertype(tolua_S,1,0);
#ifndef TOLUA_RELEASE
  if (!self) tolua_error(tolua_S,"invalid 'self' in function 'getRawTypeInfoRepository'",NULL);
#endif
  {
   EmberOgre::Authoring::RawTypeInfoRepository* tolua_ret = (EmberOgre::Authoring::RawTypeInfoRepository*)  self->getRawTypeInfoRepository();
   tolua_pushusertype(tolua_S,(void*)tolua_ret,"EmberOgre::Authoring::RawTypeInfoRepository");
  }
 }
 return 1;
#ifndef TOLUA_RELEASE
 tolua_lerror:
 tolua_error(tolua_S,"#ferror in function 'getRawTypeInfoRepository'.",&tolua_err);
 return 0;
#endif
}
#endif //#ifndef TOLUA_DISABLE

/* get function: DisplayAuthoringVisualizations of class  EmberOgre::Authoring::AuthoringManager */
#ifndef TOLUA_DISABLE_tolua_get_EmberOgre__Authoring__AuthoringManager_DisplayAuthoringVisualizations
static int tolua_get_EmberOgre__Authoring__AuthoringManager_DisplayAuthoringVisualizations(lua_State* tolua_S)
{
  EmberOgre::Authoring::AuthoringManager* self = (EmberOgre::Authoring::AuthoringManager*)  tolua_tousertype(tolua_S,1,0);
#ifndef TOLUA_RELEASE
  if (!self) tolua_error(tolua_S,"invalid 'self' in accessing variable 'DisplayAuthoringVisualizations'",NULL);
#endif
  tolua_pushusertype(tolua_S,(void*)&self->DisplayAuthoringVisualizations,"const Ember::ConsoleCommandWrapper");
 return 1;
}
#endif //#ifndef TOLUA_DISABLE

/* get function: HideAuthoringVisualizations of class  EmberOgre::Authoring::AuthoringManager */
#ifndef TOLUA_DISABLE_tolua_get_EmberOgre__Authoring__AuthoringManager_HideAuthoringVisualizations
static int tolua_get_EmberOgre__Authoring__AuthoringManager_HideAuthoringVisualizations(lua_State* tolua_S)
{
  EmberOgre::Authoring::AuthoringManager* self = (EmberOgre::Authoring::AuthoringManager*)  tolua_tousertype(tolua_S,1,0);
#ifndef TOLUA_RELEASE
  if (!self) tolua_error(tolua_S,"invalid 'self' in accessing variable 'HideAuthoringVisualizations'",NULL);
#endif
  tolua_pushusertype(tolua_S,(void*)&self->HideAuthoringVisualizations,"const Ember::ConsoleCommandWrapper");
 return 1;
}
#endif //#ifndef TOLUA_DISABLE

/* method: getRawTypeData of class  EmberOgre::Authoring::RawTypeInfoRepository */
#ifndef TOLUA_DISABLE_tolua_EmberOgre_EmberOgre_Authoring_RawTypeInfoRepository_getRawTypeData00
static int tolua_EmberOgre_EmberOgre_Authoring_RawTypeInfoRepository_getRawTypeData00(lua_State* tolua_S)
{
#ifndef TOLUA_RELEASE
 tolua_Error tolua_err;
 if (
     !tolua_isusertype(tolua_S,1,"const EmberOgre::Authoring::RawTypeInfoRepository",0,&tolua_err) ||
     !tolua_iscppstring(tolua_S,2,0,&tolua_err) ||
     !tolua_isnoobj(tolua_S,3,&tolua_err)
 )
  goto tolua_lerror;
...
#endif
 {
  const EmberOgre::Authoring::RawTypeInfoRepository* self = (const EmberOgre::Authoring::RawTypeInfoRepository*)  tolua_tousertype(tolua_S,1,0);
  const std::string typeName = ((const std::string)  tolua_tocppstring(tolua_S,2,0));
#ifndef TOLUA_RELEASE
  if (!self) tolua_error(tolua_S,"invalid 'self' in function 'getRawTypeData'",NULL);
#endif
  {
   Atlas::Objects::Root tolua_ret = (Atlas::Objects::Root)  self->getRawTypeData(typeName);
   {
#ifdef __cplusplus
...
#ifndef TOLUA_RELEASE
 tolua_lerror:
 tolua_error(tolua_S,"#ferror in function 'getRawTypeData'.",&tolua_err);
 return 0;
#endif
}
#endif //#ifndef TOLUA_DISABLE
...
/* method: clear of class  std::vector<EmberOgre::EntityPickResult> */
#ifndef TOLUA_DISABLE_tolua_EmberOgre_std_vector_EmberOgre__EntityPickResult__clear00
static int tolua_EmberOgre_std_vector_EmberOgre__EntityPickResult__clear00(lua_State* tolua_S)
{
#ifndef TOLUA_RELEASE
 tolua_Error tolua_err;
 if (
     !tolua_isusertype(tolua_S,1,"std::vector<EmberOgre::EntityPickResult>",0,&tolua_err) ||
     !tolua_isnoobj(tolua_S,2,&tolua_err)
 )
  goto tolua_lerror;
 else
...
/* method: size of class  std::vector<EmberOgre::EntityPickResult> */
#ifndef TOLUA_DISABLE_tolua_EmberOgre_std_vector_EmberOgre__EntityPickResult__size00
static int tolua_EmberOgre_std_vector_EmberOgre__EntityPickResult__size00(lua_State* tolua_S)
{
#ifndef TOLUA_RELEASE
 tolua_Error tolua_err;
 if (
     !tolua_isusertype(tolua_S,1,"const std::vector<EmberOgre::EntityPickResult>",0,&tolua_err) ||
     !tolua_isnoobj(tolua_S,2,&tolua_err)
 )
  goto tolua_lerror;
 else
#endif
 {
  const std::vector<EmberOgre::EntityPickResult>* self = (const std::vector<EmberOgre::EntityPickResult>*)  tolua_tousertype(tolua_S,1,0);
#ifndef TOLUA_RELEASE
  if (!self) tolua_error(tolua_S,"invalid 'self' in function 'size'",NULL);
#endif
  {
...
/* method: operator[] of class  std::vector<EmberOgre::EntityPickResult> */
#ifndef TOLUA_DISABLE_tolua_EmberOgre_std_vector_EmberOgre__EntityPickResult___geti00
static int tolua_EmberOgre_std_vector_EmberOgre__EntityPickResult___geti00(lua_State* tolua_S)
{
#ifndef TOLUA_RELEASE
 tolua_Error tolua_err;
 if (
...
#endif
  {
   const EmberOgre::EntityPickResult tolua_ret = (const EmberOgre::EntityPickResult)  self->operator[](index);
   {
#ifdef __cplusplus
    void* tolua_obj = new EmberOgre::EntityPickResult(tolua_ret);
    tolua_pushusertype_and_takeownership(tolua_S,tolua_obj,"const EmberOgre::EntityPickResult");
#else
    void* tolua_obj = tolua_copy(tolua_S,(void*)&tolua_ret,sizeof(const EmberOgre::EntityPickResult));
    tolua_pushusertype_and_takeownership(tolua_S,tolua_obj,"const EmberOgre::EntityPickResult");
#endif
   }
  }
...
/* method: operator&[] of class  std::vector<EmberOgre::EntityPickResult> */
#ifndef TOLUA_DISABLE_tolua_EmberOgre_std_vector_EmberOgre__EntityPickResult___seti00
static int tolua_EmberOgre_std_vector_EmberOgre__EntityPickResult___seti00(lua_State* tolua_S)
{
#ifndef TOLUA_RELEASE
 tolua_Error tolua_err;
 if (
     !tolua_isusertype(tolua_S,1,"std::vector<EmberOgre::EntityPickResult>",0,&tolua_err) ||
     !tolua_isnumber(tolua_S,2,0,&tolua_err) ||
     !tolua_isusertype(tolua_S,3,"EmberOgre::EntityPickResult",0,&tolua_err) ||
     !tolua_isnoobj(tolua_S,4,&tolua_err)
 )
  goto tolua_lerror;
 else
#endif
 {
  std::vector<EmberOgre::EntityPickResult>* self = (std::vector<EmberOgre::EntityPickResult>*)  tolua_tousertype(tolua_S,1,0);
  int index = ((int)  tolua_tonumber(tolua_S,2,0));
  EmberOgre::EntityPickResult tolua_value = *((EmberOgre::EntityPickResult*)  tolua_tousertype(tolua_S,3,0));
#ifndef TOLUA_RELEASE
  if (!self) tolua_error(tolua_S,"invalid 'self' in function 'operator&[]'",NULL);
#endif
  self->operator[](index) =  tolua_value;
...
/* method: operator[] of class  std::vector<EmberOgre::EntityPickResult> */
#ifndef TOLUA_DISABLE_tolua_EmberOgre_std_vector_EmberOgre__EntityPickResult___geti01
static int tolua_EmberOgre_std_vector_EmberOgre__EntityPickResult___geti01(lua_State* tolua_S)
{
 tolua_Error tolua_err;
 if (
     !tolua_isusertype(tolua_S,1,"std::vector<EmberOgre::EntityPickResult>",0,&tolua_err) ||
...
#endif
  {
   EmberOgre::EntityPickResult tolua_ret = (EmberOgre::EntityPickResult)  self->operator[](index);
   {
#ifdef __cplusplus
    void* tolua_obj = new EmberOgre::EntityPickResult(tolua_ret);
    tolua_pushusertype_and_takeownership(tolua_S,tolua_obj,"EmberOgre::EntityPickResult");
#else
    void* tolua_obj = tolua_copy(tolua_S,(void*)&tolua_ret,sizeof(EmberOgre::EntityPickResult));
    tolua_pushusertype_and_takeownership(tolua_S,tolua_obj,"EmberOgre::EntityPickResult");
#endif
   }
  }
 ...
 return 1;
tolua_lerror:
 return tolua_EmberOgre_std_vector_EmberOgre__EntityPickResult___geti00(tolua_S);
}
#endif //#ifndef TOLUA_DISABLE

/* method: push_back of class  std::vector<EmberOgre::EntityPickResult> */
#ifndef TOLUA_DISABLE_tolua_EmberOgre_std_vector_EmberOgre__EntityPickResult__push_back00
static int tolua_EmberOgre_std_vector_EmberOgre__EntityPickResult__push_back00(lua_State* tolua_S)
{
#ifndef TOLUA_RELEASE
 tolua_Error tolua_err;
 if (
     !tolua_isusertype(tolua_S,1,"std::vector<EmberOgre::EntityPickResult>",0,&tolua_err) ||
     !tolua_isusertype(tolua_S,2,"EmberOgre::EntityPickResult",0,&tolua_err) ||
     !tolua_isnoobj(tolua_S,3,&tolua_err)
 )
  goto tolua_lerror;
 else
 ...
 {
  std::vector<EmberOgre::EntityPickResult>* self = (std::vector<EmberOgre::EntityPickResult>*)  tolua_tousertype(tolua_S,1,0);
  EmberOgre::EntityPickResult val = *((EmberOgre::EntityPickResult*)  tolua_tousertype(tolua_S,2,0));
#ifndef TOLUA_RELEASE
  if (!self) tolua_error(tolua_S,"invalid 'self' in function 'push_back'",NULL);
#endif
  {
...
/* method: new of class  std::vector<EmberOgre::EntityPickResult> */
#ifndef TOLUA_DISABLE_tolua_EmberOgre_std_vector_EmberOgre__EntityPickResult__new00
static int tolua_EmberOgre_std_vector_EmberOgre__EntityPickResult__new00(lua_State* tolua_S)
{
#ifndef TOLUA_RELEASE
 tolua_Error tolua_err;
 if (
     !tolua_isusertable(tolua_S,1,"std::vector<EmberOgre::EntityPickResult>",0,&tolua_err) ||
     !tolua_isnoobj(tolua_S,2,&tolua_err)
 )
  goto tolua_lerror;
 else
 ...
 {
  {
   std::vector<EmberOgre::EntityPickResult>* tolua_ret = (std::vector<EmberOgre::EntityPickResult>*)  new std::vector<EmberOgre::EntityPickResult>();
   tolua_pushusertype(tolua_S,(void*)tolua_ret,"std::vector<EmberOgre::EntityPickResult>");
  }
 }
 return 1;
#ifndef TOLUA_RELEASE
...
/* method: new_local of class  std::vector<EmberOgre::EntityPickResult> */
#ifndef TOLUA_DISABLE_tolua_EmberOgre_std_vector_EmberOgre__EntityPickResult__new00_local
static int tolua_EmberOgre_std_vector_EmberOgre__EntityPickResult__new00_local(lua_State* tolua_S)
{
#ifndef TOLUA_RELEASE
 tolua_Error tolua_err;
 if (
...
#endif
 {
  {
   std::vector<EmberOgre::EntityPickResult>* tolua_ret = (std::vector<EmberOgre::EntityPickResult>*)  new std::vector<EmberOgre::EntityPickResult>();
   tolua_pushusertype_and_takeownership(tolua_S,(void *)tolua_ret,"std::vector<EmberOgre::EntityPickResult>");
  }
 }
 return 1;
#ifndef TOLUA_RELEASE
...
/* method: delete of class  std::vector<EmberOgre::EntityPickResult> */
#ifndef TOLUA_DISABLE_tolua_EmberOgre_std_vector_EmberOgre__EntityPickResult__delete00
static int tolua_EmberOgre_std_vector_EmberOgre__EntityPickResult__delete00(lua_State* tolua_S)
{
#ifndef TOLUA_RELEASE
 tolua_Error tolua_err;
 if (
...
static int tolua_EmberOgre_EmberOgre_OgreInfo_isIndirect00(lua_State* tolua_S)
{
 ...
 {
  {
   bool tolua_ret = (bool)  EmberOgre::OgreInfo::isIndirect();
   tolua_pushboolean(tolua_S,(bool)tolua_ret);
  }
 }
 return 1;
...
/* method: createUniqueResourceName of class  EmberOgre::OgreInfo */
#ifndef TOLUA_DISABLE_tolua_EmberOgre_EmberOgre_OgreInfo_createUniqueResourceName00
static int tolua_EmberOgre_EmberOgre_OgreInfo_createUniqueResourceName00(lua_State* tolua_S)
{
#ifndef TOLUA_RELEASE
 tolua_Error tolua_err;
 if (
...
#endif
 {
  const std::string resourceName = ((const std::string)  tolua_tocppstring(tolua_S,2,0));
  {
   std::string tolua_ret = (std::string)  EmberOgre::OgreInfo::createUniqueResourceName(resourceName);
   tolua_pushcppstring(tolua_S,(const char*)tolua_ret);
   tolua_pushcppstring(tolua_S,(const char*)resourceName);
  }
 }
 return 2;
#ifndef TOLUA_RELEASE
 tolua_lerror:
 tolua_error(tolua_S,"#ferror in function 'createUniqueResourceName'.",&tolua_err);
 return 0;
#endif
}
#endif //#ifndef TOLUA_DISABLE
...
/* method: getMainOgreCamera of class  EmberOgre::EmberOgre */
#ifndef TOLUA_DISABLE_tolua_EmberOgre_EmberOgre_EmberOgre_getMainOgreCamera00
static int tolua_EmberOgre_EmberOgre_EmberOgre_getMainOgreCamera00(lua_State* tolua_S)
{
#ifndef TOLUA_RELEASE
 tolua_Error tolua_err;
 if (
...
#endif
 {
  const EmberOgre::EmberOgre* self = (const EmberOgre::EmberOgre*)  tolua_tousertype(tolua_S,1,0);
#ifndef TOLUA_RELEASE
  if (!self) tolua_error(tolua_S,"invalid 'self' in function 'getMainOgreCamera'",NULL);
#endif
  {
   Ogre::Camera* tolua_ret = (Ogre::Camera*)  self->getMainOgreCamera();
   tolua_pushusertype(tolua_S,(void*)tolua_ret,"Ogre::Camera");
  }
 }
 return 1;
#ifndef TOLUA_RELEASE
 tolua_lerror:
 tolua_error(tolua_S,"#ferror in function 'getMainOgreCamera'.",&tolua_err);
 return 0;
#endif
}
#endif //#ifndef TOLUA_DISABLE

/* method: getMovementController of class  EmberOgre::EmberOgre */
#ifndef TOLUA_DISABLE_tolua_EmberOgre_EmberOgre_EmberOgre_getMovementController00
static int tolua_EmberOgre_EmberOgre_EmberOgre_getMovementController00(lua_State* tolua_S)
{
#ifndef TOLUA_RELEASE
 tolua_Error tolua_err;
 if (
...
#endif
 {
  const EmberOgre::EmberOgre* self = (const EmberOgre::EmberOgre*)  tolua_tousertype(tolua_S,1,0);
#ifndef TOLUA_RELEASE
  if (!self) tolua_error(tolua_S,"invalid 'self' in function 'getMovementController'",NULL);
#endif
  {
   EmberOgre::MovementController* tolua_ret = (EmberOgre::MovementController*)  self->getMovementController();
   tolua_pushusertype(tolua_S,(void*)tolua_ret,"EmberOgre::MovementController");
  }
 }
 return 1;
#ifndef TOLUA_RELEASE
 tolua_lerror:
 tolua_error(tolua_S,"#ferror in function 'getMovementController'.",&tolua_err);
 return 0;
#endif
}
#endif //#ifndef TOLUA_DISABLE
...
#endif
  {
   EmberOgre::Authoring::EntityMoveManager* tolua_ret = (EmberOgre::Authoring::EntityMoveManager*)  self->getMoveManager();
   tolua_pushusertype(tolua_S,(void*)tolua_ret,"EmberOgre::Authoring::EntityMoveManager");
  }
 }
 return 1;
#ifndef TOLUA_RELEASE
...
/* get function: EventTerrainManagerCreated of class  EmberOgre::EmberOgre */
#ifndef TOLUA_DISABLE_tolua_get_EmberOgre__EmberOgre_EventTerrainManagerCreated
static int tolua_get_EmberOgre__EmberOgre_EventTerrainManagerCreated(lua_State* tolua_S)
{
  EmberOgre::EmberOgre* self = (EmberOgre::EmberOgre*)  tolua_tousertype(tolua_S,1,0);
#ifndef TOLUA_RELEASE
  if (!self) tolua_error(tolua_S,"invalid 'self' in accessing variable 'EventTerrainManagerCreated'",NULL);
#endif
  tolua_pushusertype(tolua_S,(void*)&self->EventTerrainManagerCreated,"sigc::signal<void,EmberOgre::Terrain::TerrainManager&>");
 return 1;
}
#endif //#ifndef TOLUA_DISABLE

/* set function: EventTerrainManagerCreated of class  EmberOgre::EmberOgre */
#ifndef TOLUA_DISABLE_tolua_set_EmberOgre__EmberOgre_EventTerrainManagerCreated
static int tolua_set_EmberOgre__EmberOgre_EventTerrainManagerCreated(lua_State* tolua_S)
{
  EmberOgre::EmberOgre* self = (EmberOgre::EmberOgre*)  tolua_tousertype(tolua_S,1,0);
#ifndef TOLUA_RELEASE
  tolua_Error tolua_err;
  if (!self) tolua_error(tolua_S,"invalid 'self' in accessing variable 'EventTerrainManagerCreated'",NULL);
  if (!tolua_isusertype(tolua_S,2,"sigc::signal<void,EmberOgre::Terrain::TerrainManager&>",0,&tolua_err))
   tolua_error(tolua_S,"#vinvalid type in variable assignment.",&tolua_err);
#endif
  self->EventTerrainManagerCreated = *((sigc::signal<void,EmberOgre::Terrain::TerrainManager&>*)  tolua_tousertype(tolua_S,2,0))
;
 return 0;
}
#endif //#ifndef TOLUA_DISABLE
...
static int tolua_get_EmberOgre__EmberOgre_EventMovementControllerCreated(lua_State* tolua_S)
{
  EmberOgre::EmberOgre* self = (EmberOgre::EmberOgre*)  tolua_tousertype(tolua_S,1,0);
#ifndef TOLUA_RELEASE
  if (!self) tolua_error(tolua_S,"invalid 'self' in accessing variable 'EventMovementControllerCreated'",NULL);
#endif
  tolua_pushusertype(tolua_S,(void*)&self->EventMovementControllerCreated,"sigc::signal<void>");
 return 1;
}
#endif //#ifndef TOLUA_DISABLE

/* set function: EventMovementControllerCreated of class  EmberOgre::EmberOgre */
#ifndef TOLUA_DISABLE_tolua_set_EmberOgre__EmberOgre_EventMovementControllerCreated
static int tolua_set_EmberOgre__EmberOgre_EventMovementControllerCreated(lua_State* tolua_S)
{
  EmberOgre::EmberOgre* self = (EmberOgre::EmberOgre*)  tolua_tousertype(tolua_S,1,0);
#ifndef TOLUA_RELEASE
  tolua_Error tolua_err;
  ...
  if (!tolua_isusertype(tolua_S,2,"sigc::signal<void>",0,&tolua_err))
   tolua_error(tolua_S,"#vinvalid type in variable assignment.",&tolua_err);
#endif
  self->EventMovementControllerCreated = *((sigc::signal<void>*)  tolua_tousertype(tolua_S,2,0))
;
 return 0;
}
#endif //#ifndef TOLUA_DISABLE
...
TOLUA_API int tolua_EmberOgre_open (lua_State* tolua_S)
{
 ...
 tolua_beginmodule(tolua_S,NULL);
  ...
  tolua_module(tolua_S,"EmberOgre",0);
  tolua_beginmodule(tolua_S,"EmberOgre");
   tolua_cclass(tolua_S,"MovementControllerMode","EmberOgre::MovementControllerMode","",NULL);
   tolua_beginmodule(tolua_S,"MovementControllerMode");
    tolua_constant(tolua_S,"MM_WALK",EmberOgre::MovementControllerMode::MM_WALK);
    tolua_constant(tolua_S,"MM_RUN",EmberOgre::MovementControllerMode::MM_RUN);
   tolua_endmodule(tolua_S);
   tolua_cclass(tolua_S,"MovementController","EmberOgre::MovementController","",NULL);
   tolua_beginmodule(tolua_S,"MovementController");
    tolua_variable(tolua_S,"EventMovementModeChanged",tolua_get_EmberOgre__MovementController_EventMovementModeChanged,tolua_set_EmberOgre__MovementController_EventMovementModeChanged);
    tolua_function(tolua_S,"moveToPoint",tolua_EmberOgre_EmberOgre_MovementController_moveToPoint00);
    tolua_function(tolua_S,"teleportTo",tolua_EmberOgre_EmberOgre_MovementController_teleportTo00);
    tolua_function(tolua_S,"getMode",tolua_EmberOgre_EmberOgre_MovementController_getMode00);
   tolua_endmodule(tolua_S);
  tolua_endmodule(tolua_S);
  tolua_module(tolua_S,"EmberOgre",0);
  tolua_beginmodule(tolua_S,"EmberOgre");
   ...
   tolua_beginmodule(tolua_S,"Avatar");
    ...
    tolua_function(tolua_S,"getClientSideAvatarPosition",tolua_EmberOgre_EmberOgre_Avatar_getClientSideAvatarPosition00);
    tolua_function(tolua_S,"getClientSideAvatarOrientation",tolua_EmberOgre_EmberOgre_Avatar_getClientSideAvatarOrientation00);
   tolua_endmodule(tolua_S);
  tolua_endmodule(tolua_S);
  tolua_module(tolua_S,"EmberOgre",0);
  tolua_beginmodule(tolua_S,"EmberOgre");
   ...
   tolua_beginmodule(tolua_S,"EmberEntityFactory");
    ...
    tolua_function(tolua_S,"getAuthoringManager",tolua_EmberOgre_EmberOgre_EmberEntityFactory_getAuthoringManager00);
   tolua_endmodule(tolua_S);
  tolua_endmodule(tolua_S);
  tolua_module(tolua_S,"EmberOgre",0);
  tolua_beginmodule(tolua_S,"EmberOgre");
   ...
   tolua_beginmodule(tolua_S,"EmberEntity");
    ...
    tolua_function(tolua_S,"getAttachedEntity",tolua_EmberOgre_EmberOgre_EmberEntity_getAttachedEntity00);
   tolua_endmodule(tolua_S);
  tolua_endmodule(tolua_S);
  tolua_module(tolua_S,"EmberOgre",0);
  tolua_beginmodule(tolua_S,"EmberOgre");
  ...
  tolua_beginmodule(tolua_S,"EmberOgre");
   ...
   tolua_beginmodule(tolua_S,"Terrain");
    ...
    tolua_beginmodule(tolua_S,"TerrainManager");
     tolua_function(tolua_S,"getMax",tolua_EmberOgre_EmberOgre_Terrain_TerrainManager_getMax00);
     tolua_function(tolua_S,"getMin",tolua_EmberOgre_EmberOgre_Terrain_TerrainManager_getMin00);
     tolua_function(tolua_S,"getPageMetersSize",tolua_EmberOgre_EmberOgre_Terrain_TerrainManager_getPageMetersSize00);
  ...
  tolua_beginmodule(tolua_S,"EmberOgre");
   ...
   tolua_beginmodule(tolua_S,"Terrain");
    ...
    tolua_beginmodule(tolua_S,"TerrainEditor");
     ...
     tolua_variable(tolua_S,"EventOverlayCreated",tolua_get_EmberOgre__Terrain__TerrainEditor_EventOverlayCreated,tolua_set_EmberOgre__Terrain__TerrainEditor_EventOverlayCreated);
     ...
     tolua_function(tolua_S,"setFalloff",tolua_EmberOgre_EmberOgre_Terrain_TerrainEditor_setFalloff00);
    tolua_endmodule(tolua_S);
    tolua_cclass(tolua_S,"TerrainEditorOverlay","EmberOgre::Terrain::TerrainEditorOverlay","",NULL);
    tolua_beginmodule(tolua_S,"TerrainEditorOverlay");
     tolua_function(tolua_S,"commitAction",tolua_EmberOgre_EmberOgre_Terrain_TerrainEditorOverlay_commitAction00);
     tolua_function(tolua_S,"getCurrentBasePointUserObject",tolua_EmberOgre_EmberOgre_Terrain_TerrainEditorOverlay_getCurrentBasePointUserObject00);
     tolua_function(tolua_S,"sendChangesToServer",tolua_EmberOgre_EmberOgre_Terrain_TerrainEditorOverlay_sendChangesToServer00);
     tolua_function(tolua_S,"createAction",tolua_EmberOgre_EmberOgre_Terrain_TerrainEditorOverlay_createAction00);
     tolua_function(tolua_S,"undoLastAction",tolua_EmberOgre_EmberOgre_Terrain_TerrainEditorOverlay_undoLastAction00);
     tolua_function(tolua_S,"redoAction",tolua_EmberOgre_EmberOgre_Terrain_TerrainEditorOverlay_redoAction00);
     tolua_variable(tolua_S,"EventPickedBasePoint",tolua_get_EmberOgre__Terrain__TerrainEditorOverlay_EventPickedBasePoint,tolua_set_EmberOgre__Terrain__TerrainEditorOverlay_EventPickedBasePoint);
     tolua_variable(tolua_S,"EventActionCreated",tolua_get_EmberOgre__Terrain__TerrainEditorOverlay_EventActionCreated,tolua_set_EmberOgre__Terrain__TerrainEditorOverlay_EventActionCreated);
     tolua_variable(tolua_S,"EventSelectedBasePointUpdatedPosition",tolua_get_EmberOgre__Terrain__TerrainEditorOverlay_EventSelectedBasePointUpdatedPosition,tolua_set_EmberOgre__Terrain__TerrainEditorOverlay_EventSelectedBasePointUpdatedPosition);
    tolua_endmodule(tolua_S);
   tolua_endmodule(tolua_S);
  tolua_endmodule(tolua_S);
  tolua_module(tolua_S,"EmberOgre",0);
  tolua_beginmodule(tolua_S,"EmberOgre");
   tolua_cclass(tolua_S,"IAnimated","EmberOgre::IAnimated","",NULL);
   tolua_beginmodule(tolua_S,"IAnimated");
    tolua_function(tolua_S,"updateAnimation",tolua_EmberOgre_EmberOgre_IAnimated_updateAnimation00);
   tolua_endmodule(tolua_S);
  ...
  tolua_beginmodule(tolua_S,"EmberOgre");
   ...
   tolua_beginmodule(tolua_S,"Gui");
    ...
    tolua_beginmodule(tolua_S,"AssetsManager");
     ...
     tolua_function(tolua_S,"resolveFilePathForMesh",tolua_EmberOgre_EmberOgre_Gui_AssetsManager_resolveFilePathForMesh00);
     tolua_function(tolua_S,"exportMesh",tolua_EmberOgre_EmberOgre_Gui_AssetsManager_exportMesh00);
    tolua_endmodule(tolua_S);
   tolua_endmodule(tolua_S);
  tolua_endmodule(tolua_S);
  tolua_module(tolua_S,"EmberOgre",0);
  tolua_beginmodule(tolua_S,"EmberOgre");
   tolua_module(tolua_S,"Gui",0);
   tolua_beginmodule(tolua_S,"Gui");
    tolua_cclass(tolua_S,"AtlasHelper","EmberOgre::Gui::AtlasHelper","",NULL);
    tolua_beginmodule(tolua_S,"AtlasHelper");
     tolua_function(tolua_S,"serialize",tolua_EmberOgre_EmberOgre_Gui_AtlasHelper_serialize00);
     tolua_function(tolua_S,"serialize",tolua_EmberOgre_EmberOgre_Gui_AtlasHelper_serialize01);
    tolua_endmodule(tolua_S);
   tolua_endmodule(tolua_S);
  tolua_endmodule(tolua_S);
  tolua_module(tolua_S,"EmberOgre",0);
   ...
   tolua_beginmodule(tolua_S,"Gui");
    ...
    tolua_beginmodule(tolua_S,"Adapters");
     ...
     tolua_beginmodule(tolua_S,"Eris");
      #ifdef __cplusplus
      tolua_cclass(tolua_S,"TypeTreeAdapter","EmberOgre::Gui::Adapters::Eris::TypeTreeAdapter","virtual sigc::trackable",tolua_collect_EmberOgre__Gui__Adapters__Eris__TypeTreeAdapter);
      #else
      tolua_cclass(tolua_S,"TypeTreeAdapter","EmberOgre::Gui::Adapters::Eris::TypeTreeAdapter","virtual sigc::trackable",NULL);
      #endif
      tolua_beginmodule(tolua_S,"TypeTreeAdapter");
       tolua_function(tolua_S,"new",tolua_EmberOgre_EmberOgre_Gui_Adapters_Eris_TypeTreeAdapter_new00);
       tolua_function(tolua_S,"new_local",tolua_EmberOgre_EmberOgre_Gui_Adapters_Eris_TypeTreeAdapter_new00_local);
       tolua_function(tolua_S,".call",tolua_EmberOgre_EmberOgre_Gui_Adapters_Eris_TypeTreeAdapter_new00_local);
       tolua_function(tolua_S,"delete",tolua_EmberOgre_EmberOgre_Gui_Adapters_Eris_TypeTreeAdapter_delete00);
       tolua_function(tolua_S,"initialize",tolua_EmberOgre_EmberOgre_Gui_Adapters_Eris_TypeTreeAdapter_initialize00);
       tolua_function(tolua_S,"getSelectedTypeInfo",tolua_EmberOgre_EmberOgre_Gui_Adapters_Eris_TypeTreeAdapter_getSelectedTypeInfo00);
      tolua_endmodule(tolua_S);
     tolua_endmodule(tolua_S);
    tolua_endmodule(tolua_S);
   tolua_endmodule(tolua_S);
   ...
   tolua_beginmodule(tolua_S,"Gui");
    ...
    tolua_beginmodule(tolua_S,"Adapters");
     ...
     tolua_beginmodule(tolua_S,"Ogre");
      #ifdef __cplusplus
      tolua_cclass(tolua_S,"ResourceListAdapter","EmberOgre::Gui::Adapters::Ogre::ResourceListAdapter","",tolua_collect_EmberOgre__Gui__Adapters__Ogre__ResourceListAdapter);
      #else
      tolua_cclass(tolua_S,"ResourceListAdapter","EmberOgre::Gui::Adapters::Ogre::ResourceListAdapter","",NULL);
      #endif
      tolua_beginmodule(tolua_S,"ResourceListAdapter");
       tolua_function(tolua_S,"new",tolua_EmberOgre_EmberOgre_Gui_Adapters_Ogre_ResourceListAdapter_new00);
       tolua_function(tolua_S,"new_local",tolua_EmberOgre_EmberOgre_Gui_Adapters_Ogre_ResourceListAdapter_new00_local);
       tolua_function(tolua_S,".call",tolua_EmberOgre_EmberOgre_Gui_Adapters_Ogre_ResourceListAdapter_new00_local);
       tolua_function(tolua_S,"delete",tolua_EmberOgre_EmberOgre_Gui_Adapters_Ogre_ResourceListAdapter_delete00);
       tolua_function(tolua_S,"update",tolua_EmberOgre_EmberOgre_Gui_Adapters_Ogre_ResourceListAdapter_update00);
      tolua_endmodule(tolua_S);
     tolua_endmodule(tolua_S);
    tolua_endmodule(tolua_S);
   tolua_endmodule(tolua_S);
  ...
  tolua_beginmodule(tolua_S,"EmberOgre");
   #ifdef __cplusplus
   tolua_cclass(tolua_S,"EntityPickResult","EmberOgre::EntityPickResult","",tolua_collect_EmberOgre__EntityPickResult);
   #else
  ...
  tolua_beginmodule(tolua_S,"EmberOgre");
   ...
   tolua_beginmodule(tolua_S,"Authoring");
    tolua_cclass(tolua_S,"EntityMover","EmberOgre::Authoring::EntityMover","",NULL);
    tolua_beginmodule(tolua_S,"EntityMover");
    tolua_endmodule(tolua_S);
    tolua_cclass(tolua_S,"EntityMoveManager","EmberOgre::Authoring::EntityMoveManager","",NULL);
    tolua_beginmodule(tolua_S,"EntityMoveManager");
     tolua_function(tolua_S,"startMove",tolua_EmberOgre_EmberOgre_Authoring_EntityMoveManager_startMove00);
     tolua_function(tolua_S,"runCommand",tolua_EmberOgre_EmberOgre_Authoring_EntityMoveManager_runCommand00);
     tolua_variable(tolua_S,"EventStartMoving",tolua_get_EmberOgre__Authoring__EntityMoveManager_EventStartMoving,tolua_set_EmberOgre__Authoring__EntityMoveManager_EventStartMoving);
     tolua_variable(tolua_S,"EventFinishedMoving",tolua_get_EmberOgre__Authoring__EntityMoveManager_EventFinishedMoving,tolua_set_EmberOgre__Authoring__EntityMoveManager_EventFinishedMoving);
     tolua_variable(tolua_S,"EventCancelledMoving",tolua_get_EmberOgre__Authoring__EntityMoveManager_EventCancelledMoving,tolua_set_EmberOgre__Authoring__EntityMoveManager_EventCancelledMoving);
    tolua_endmodule(tolua_S);
   tolua_endmodule(tolua_S);
  tolua_endmodule(tolua_S);
  tolua_module(tolua_S,"EmberOgre",0);
  tolua_beginmodule(tolua_S,"EmberOgre");
   ...
   tolua_beginmodule(tolua_S,"Authoring");
    #ifdef __cplusplus
    tolua_cclass(tolua_S,"GUIAdapter","EmberOgre::Authoring::GUIAdapter","",tolua_collect_EmberOgre__Authoring__GUIAdapter);
    #else
    tolua_cclass(tolua_S,"GUIAdapter","EmberOgre::Authoring::GUIAdapter","",NULL);
    #endif
    tolua_beginmodule(tolua_S,"GUIAdapter");
     tolua_function(tolua_S,"new",tolua_EmberOgre_EmberOgre_Authoring_GUIAdapter_new00);
     tolua_function(tolua_S,"new_local",tolua_EmberOgre_EmberOgre_Authoring_GUIAdapter_new00_local);
     tolua_function(tolua_S,".call",tolua_EmberOgre_EmberOgre_Authoring_GUIAdapter_new00_local);
     tolua_function(tolua_S,"delete",tolua_EmberOgre_EmberOgre_Authoring_GUIAdapter_delete00);
     tolua_function(tolua_S,"getType",tolua_EmberOgre_EmberOgre_Authoring_GUIAdapter_getType00);
     tolua_function(tolua_S,"attach",tolua_EmberOgre_EmberOgre_Authoring_GUIAdapter_attach00);
     tolua_function(tolua_S,"detach",tolua_EmberOgre_EmberOgre_Authoring_GUIAdapter_detach00);
     tolua_function(tolua_S,"getValue",tolua_EmberOgre_EmberOgre_Authoring_GUIAdapter_getValue00);
     tolua_function(tolua_S,"setTitle",tolua_EmberOgre_EmberOgre_Authoring_GUIAdapter_setTitle00);
     tolua_function(tolua_S,"getTitle",tolua_EmberOgre_EmberOgre_Authoring_GUIAdapter_getTitle00);
     tolua_function(tolua_S,"setTooltip",tolua_EmberOgre_EmberOgre_Authoring_GUIAdapter_setTooltip00);
     tolua_function(tolua_S,"getTooltip",tolua_EmberOgre_EmberOgre_Authoring_GUIAdapter_getTooltip00);
     tolua_function(tolua_S,"addSuggestion",tolua_EmberOgre_EmberOgre_Authoring_GUIAdapter_addSuggestion00);
    tolua_endmodule(tolua_S);
   tolua_endmodule(tolua_S);
  tolua_endmodule(tolua_S);
  tolua_module(tolua_S,"EmberOgre",0);
  tolua_beginmodule(tolua_S,"EmberOgre");
   ...
   tolua_beginmodule(tolua_S,"Authoring");
    #ifdef __cplusplus
    tolua_cclass(tolua_S,"EntityRecipe","EmberOgre::Authoring::EntityRecipe","Ogre::Resource",tolua_collect_EmberOgre__Authoring__EntityRecipe);
    #else
    tolua_cclass(tolua_S,"EntityRecipe","EmberOgre::Authoring::EntityRecipe","Ogre::Resource",NULL);
    #endif
    tolua_beginmodule(tolua_S,"EntityRecipe");
     tolua_function(tolua_S,"new",tolua_EmberOgre_EmberOgre_Authoring_EntityRecipe_new00);
     tolua_function(tolua_S,"new_local",tolua_EmberOgre_EmberOgre_Authoring_EntityRecipe_new00_local);
     tolua_function(tolua_S,".call",tolua_EmberOgre_EmberOgre_Authoring_EntityRecipe_new00_local);
     tolua_function(tolua_S,"delete",tolua_EmberOgre_EmberOgre_Authoring_EntityRecipe_delete00);
     tolua_function(tolua_S,"loadImpl",tolua_EmberOgre_EmberOgre_Authoring_EntityRecipe_loadImpl00);
     tolua_function(tolua_S,"unloadImpl",tolua_EmberOgre_EmberOgre_Authoring_EntityRecipe_unloadImpl00);
     tolua_function(tolua_S,"calculateSize",tolua_EmberOgre_EmberOgre_Authoring_EntityRecipe_calculateSize00);
     tolua_function(tolua_S,"getGUIAdapters",tolua_EmberOgre_EmberOgre_Authoring_EntityRecipe_getGUIAdapters00);
     tolua_function(tolua_S,"setAuthor",tolua_EmberOgre_EmberOgre_Authoring_EntityRecipe_setAuthor00);
     tolua_function(tolua_S,"getAuthor",tolua_EmberOgre_EmberOgre_Authoring_EntityRecipe_getAuthor00);
     tolua_function(tolua_S,"setDescription",tolua_EmberOgre_EmberOgre_Authoring_EntityRecipe_setDescription00);
     tolua_function(tolua_S,"getDescription",tolua_EmberOgre_EmberOgre_Authoring_EntityRecipe_getDescription00);
     tolua_function(tolua_S,"createEntity",tolua_EmberOgre_EmberOgre_Authoring_EntityRecipe_createEntity00);
    tolua_endmodule(tolua_S);
    tolua_cclass(tolua_S,"EntityRecipePtr","EmberOgre::Authoring::EntityRecipePtr","",NULL);
    tolua_beginmodule(tolua_S,"EntityRecipePtr");
     tolua_function(tolua_S,"get",tolua_EmberOgre_EmberOgre_Authoring_EntityRecipePtr_get00);
    tolua_endmodule(tolua_S);
    tolua_cclass(tolua_S,"GUIAdaptersStore","EmberOgre::Authoring::GUIAdaptersStore","",NULL);
    tolua_beginmodule(tolua_S,"GUIAdaptersStore");
     tolua_cclass(tolua_S,"value_type","EmberOgre::Authoring::GUIAdaptersStore::value_type","",NULL);
     tolua_beginmodule(tolua_S,"value_type");
      tolua_variable(tolua_S,"first",tolua_get_EmberOgre__Authoring__GUIAdaptersStore__value_type_first,NULL);
      tolua_variable(tolua_S,"second",tolua_get_EmberOgre__Authoring__GUIAdaptersStore__value_type_second_ptr,tolua_set_EmberOgre__Authoring__GUIAdaptersStore__value_type_second_ptr);
     tolua_endmodule(tolua_S);
     #ifdef __cplusplus
     tolua_cclass(tolua_S,"const_iterator","EmberOgre::Authoring::GUIAdaptersStore::const_iterator","",tolua_collect_EmberOgre__Authoring__GUIAdaptersStore__const_iterator);
     #else
     tolua_cclass(tolua_S,"const_iterator","EmberOgre::Authoring::GUIAdaptersStore::const_iterator","",NULL);
     #endif
     tolua_beginmodule(tolua_S,"const_iterator");
      tolua_function(tolua_S,"get",tolua_EmberOgre_EmberOgre_Authoring_GUIAdaptersStore_const_iterator_get00);
      tolua_function(tolua_S,"next",tolua_EmberOgre_EmberOgre_Authoring_GUIAdaptersStore_const_iterator_next00);
      tolua_function(tolua_S,".eq",tolua_EmberOgre_EmberOgre_Authoring_GUIAdaptersStore_const_iterator__eq00);
     tolua_endmodule(tolua_S);
     tolua_function(tolua_S,"begin",tolua_EmberOgre_EmberOgre_Authoring_GUIAdaptersStore_begin00);
     tolua_function(tolua_S,"theEnd",tolua_EmberOgre_EmberOgre_Authoring_GUIAdaptersStore_theEnd00);
    tolua_endmodule(tolua_S);
   tolua_endmodule(tolua_S);
  tolua_endmodule(tolua_S);
  ...
  { /* begin embedded lua code */
   ...
   static unsigned char B[] = {
    10,102,117,110, 99,116,105,111,110, 32, 69,109, 98,101,114,
     79,103,114,101, 46, 65,117,116,104,111,114,105,110,103, 46,
     71, 85, 73, 65,100, 97,112,116,101,114,115, 83,116,111,114,
    101, 58,112, 97,105,114,115, 40, 41, 10,108,111, 99, 97,108,
     32, 73, 32, 61, 32,115,101,108,102, 58, 98,101,103,105,110,
     40, 41, 10,108,111, 99, 97,108, 32, 73,101,110,100, 32, 61,
     32,115,101,108,102, 58,116,104,101, 69,110,100, 40, 41, 10,
    114,101,116,117,114,110, 32,102,117,110, 99,116,105,111,110,
     40, 41, 10,105,102, 32, 73, 32,126, 61, 32, 73,101,110,100,
     32,116,104,101,110, 10,108,111, 99, 97,108, 32,118, 97,108,
     32, 61, 32, 73, 58,103,101,116, 40, 41, 10, 73, 32, 61, 32,
     73, 58,110,101,120,116, 40, 41, 10,114,101,116,117,114,110,
     32,118, 97,108, 46,102,105,114,115,116, 44, 32,118, 97,108,
     46,115,101, 99,111,110,100, 10,101,110,100, 10,101,110,100,
     10,101,110,100,32
   };
  ...
  tolua_beginmodule(tolua_S,"EmberOgre");
   ...
   tolua_beginmodule(tolua_S,"Authoring");
    #ifdef __cplusplus
    tolua_cclass(tolua_S,"EntityRecipeManager","EmberOgre::Authoring::EntityRecipeManager","Ogre::ResourceManager",tolua_collect_EmberOgre__Authoring__EntityRecipeManager);
    #else
    tolua_cclass(tolua_S,"EntityRecipeManager","EmberOgre::Authoring::EntityRecipeManager","Ogre::ResourceManager",NULL);
    #endif
    tolua_beginmodule(tolua_S,"EntityRecipeManager");
     tolua_function(tolua_S,"getSingleton",tolua_EmberOgre_EmberOgre_Authoring_EntityRecipeManager_getSingleton00);
     tolua_function(tolua_S,"new",tolua_EmberOgre_EmberOgre_Authoring_EntityRecipeManager_new00);
     tolua_function(tolua_S,"new_local",tolua_EmberOgre_EmberOgre_Authoring_EntityRecipeManager_new00_local);
     tolua_function(tolua_S,".call",tolua_EmberOgre_EmberOgre_Authoring_EntityRecipeManager_new00_local);
     tolua_function(tolua_S,"delete",tolua_EmberOgre_EmberOgre_Authoring_EntityRecipeManager_delete00);
     tolua_function(tolua_S,"create",tolua_EmberOgre_EmberOgre_Authoring_EntityRecipeManager_create00);
     tolua_function(tolua_S,"parseScript",tolua_EmberOgre_EmberOgre_Authoring_EntityRecipeManager_parseScript00);
     tolua_variable(tolua_S,"__Ember__Singleton_EntityRecipeManager___",tolua_get_EmberOgre__Authoring__EntityRecipeManager___Ember__Singleton_EntityRecipeManager___,NULL);
    tolua_endmodule(tolua_S);
   tolua_endmodule(tolua_S);
  tolua_endmodule(tolua_S);
  tolua_module(tolua_S,"EmberOgre",0);
  ...
  tolua_beginmodule(tolua_S,"EmberOgre");
   tolua_module(tolua_S,"Authoring",0);
   tolua_beginmodule(tolua_S,"Authoring");
    tolua_cclass(tolua_S,"AuthoringManager","EmberOgre::Authoring::AuthoringManager","",NULL);
    tolua_beginmodule(tolua_S,"AuthoringManager");
     tolua_function(tolua_S,"displayAuthoringVisualization",tolua_EmberOgre_EmberOgre_Authoring_AuthoringManager_displayAuthoringVisualization00);
     tolua_function(tolua_S,"hideAuthoringVisualization",tolua_EmberOgre_EmberOgre_Authoring_AuthoringManager_hideAuthoringVisualization00);
     tolua_function(tolua_S,"startMovement",tolua_EmberOgre_EmberOgre_Authoring_AuthoringManager_startMovement00);
     tolua_function(tolua_S,"stopMovement",tolua_EmberOgre_EmberOgre_Authoring_AuthoringManager_stopMovement00);
     tolua_function(tolua_S,"getRawTypeInfoRepository",tolua_EmberOgre_EmberOgre_Authoring_AuthoringManager_getRawTypeInfoRepository00);
     tolua_variable(tolua_S,"DisplayAuthoringVisualizations",tolua_get_EmberOgre__Authoring__AuthoringManager_DisplayAuthoringVisualizations,NULL);
     tolua_variable(tolua_S,"HideAuthoringVisualizations",tolua_get_EmberOgre__Authoring__AuthoringManager_HideAuthoringVisualizations,NULL);
    tolua_endmodule(tolua_S);
   tolua_endmodule(tolua_S);
  tolua_endmodule(tolua_S);
  tolua_module(tolua_S,"EmberOgre",0);
  ...
  tolua_beginmodule(tolua_S,"std");
   ...
   tolua_endmodule(tolua_S);
   #ifdef __cplusplus
   tolua_cclass(tolua_S,"vector_EmberOgre__EntityPickResult_","std::vector<EmberOgre::EntityPickResult>","",tolua_collect_std__vector_EmberOgre__EntityPickResult_);
   #else
   tolua_cclass(tolua_S,"vector_EmberOgre__EntityPickResult_","std::vector<EmberOgre::EntityPickResult>","",NULL);
   #endif
   tolua_beginmodule(tolua_S,"vector_EmberOgre__EntityPickResult_");
    tolua_function(tolua_S,"clear",tolua_EmberOgre_std_vector_EmberOgre__EntityPickResult__clear00);
    tolua_function(tolua_S,"size",tolua_EmberOgre_std_vector_EmberOgre__EntityPickResult__size00);
    tolua_function(tolua_S,".geti",tolua_EmberOgre_std_vector_EmberOgre__EntityPickResult___geti00);
    tolua_function(tolua_S,".seti",tolua_EmberOgre_std_vector_EmberOgre__EntityPickResult___seti00);
    tolua_function(tolua_S,".geti",tolua_EmberOgre_std_vector_EmberOgre__EntityPickResult___geti01);
    tolua_function(tolua_S,"push_back",tolua_EmberOgre_std_vector_EmberOgre__EntityPickResult__push_back00);
    tolua_function(tolua_S,"new",tolua_EmberOgre_std_vector_EmberOgre__EntityPickResult__new00);
    tolua_function(tolua_S,"new_local",tolua_EmberOgre_std_vector_EmberOgre__EntityPickResult__new00_local);
    tolua_function(tolua_S,".call",tolua_EmberOgre_std_vector_EmberOgre__EntityPickResult__new00_local);
    tolua_function(tolua_S,"delete",tolua_EmberOgre_std_vector_EmberOgre__EntityPickResult__delete00);
   tolua_endmodule(tolua_S);
   #ifdef __cplusplus
  ...
  tolua_beginmodule(tolua_S,"EmberOgre");
   ...
   tolua_beginmodule(tolua_S,"OgreInfo");
    ...
    tolua_function(tolua_S,"createUniqueResourceName",tolua_EmberOgre_EmberOgre_OgreInfo_createUniqueResourceName00);
   tolua_endmodule(tolua_S);
  tolua_endmodule(tolua_S);
  tolua_module(tolua_S,"EmberOgre",0);
  tolua_beginmodule(tolua_S,"EmberOgre");
  ...
  tolua_beginmodule(tolua_S,"EmberOgre");
   ...
   tolua_beginmodule(tolua_S,"EmberOgre");
    ...
    tolua_function(tolua_S,"getMainOgreCamera",tolua_EmberOgre_EmberOgre_EmberOgre_getMainOgreCamera00);
    tolua_function(tolua_S,"getMovementController",tolua_EmberOgre_EmberOgre_EmberOgre_getMovementController00);
