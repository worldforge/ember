...
#endif
  tolua_pushusertype(tolua_S,(void*)&self->EventStartErisPoll,"sigc::signal<void,float>");
 return 1;
}
#endif //#ifndef TOLUA_DISABLE
...
static int tolua_set_Ember__Application_EventStartErisPoll(lua_State* tolua_S)
{
  ...
  if (!tolua_isusertype(tolua_S,2,"sigc::signal<void,float>",0,&tolua_err))
   tolua_error(tolua_S,"#vinvalid type in variable assignment.",&tolua_err);
#endif
  self->EventStartErisPoll = *((sigc::signal<void,float>*)  tolua_tousertype(tolua_S,2,0))
;
 return 0;
}
#endif //#ifndef TOLUA_DISABLE
...
#endif
  tolua_pushusertype(tolua_S,(void*)&self->EventEndErisPoll,"sigc::signal<void,float>");
 return 1;
}
#endif //#ifndef TOLUA_DISABLE
...
static int tolua_set_Ember__Application_EventEndErisPoll(lua_State* tolua_S)
{
  ...
  if (!tolua_isusertype(tolua_S,2,"sigc::signal<void,float>",0,&tolua_err))
   tolua_error(tolua_S,"#vinvalid type in variable assignment.",&tolua_err);
#endif
  self->EventEndErisPoll = *((sigc::signal<void,float>*)  tolua_tousertype(tolua_S,2,0))
;
 return 0;
}
#endif //#ifndef TOLUA_DISABLE

/* get function: EventBeforeInputProcessing of class  Ember::Application */
#ifndef TOLUA_DISABLE_tolua_get_Ember__Application_EventBeforeInputProcessing
static int tolua_get_Ember__Application_EventBeforeInputProcessing(lua_State* tolua_S)
{
  Ember::Application* self = (Ember::Application*)  tolua_tousertype(tolua_S,1,0);
#ifndef TOLUA_RELEASE
  if (!self) tolua_error(tolua_S,"invalid 'self' in accessing variable 'EventBeforeInputProcessing'",NULL);
#endif
  tolua_pushusertype(tolua_S,(void*)&self->EventBeforeInputProcessing,"sigc::signal<void,float>");
 return 1;
}
#endif //#ifndef TOLUA_DISABLE

/* set function: EventBeforeInputProcessing of class  Ember::Application */
#ifndef TOLUA_DISABLE_tolua_set_Ember__Application_EventBeforeInputProcessing
static int tolua_set_Ember__Application_EventBeforeInputProcessing(lua_State* tolua_S)
{
  Ember::Application* self = (Ember::Application*)  tolua_tousertype(tolua_S,1,0);
#ifndef TOLUA_RELEASE
  tolua_Error tolua_err;
  ...
  if (!tolua_isusertype(tolua_S,2,"sigc::signal<void,float>",0,&tolua_err))
   tolua_error(tolua_S,"#vinvalid type in variable assignment.",&tolua_err);
#endif
  self->EventBeforeInputProcessing = *((sigc::signal<void,float>*)  tolua_tousertype(tolua_S,2,0))
;
 return 0;
}
#endif //#ifndef TOLUA_DISABLE

/* get function: EventAfterInputProcessing of class  Ember::Application */
#ifndef TOLUA_DISABLE_tolua_get_Ember__Application_EventAfterInputProcessing
static int tolua_get_Ember__Application_EventAfterInputProcessing(lua_State* tolua_S)
{
  Ember::Application* self = (Ember::Application*)  tolua_tousertype(tolua_S,1,0);
#ifndef TOLUA_RELEASE
  if (!self) tolua_error(tolua_S,"invalid 'self' in accessing variable 'EventAfterInputProcessing'",NULL);
#endif
  tolua_pushusertype(tolua_S,(void*)&self->EventAfterInputProcessing,"sigc::signal<void,float>");
 return 1;
}
#endif //#ifndef TOLUA_DISABLE

/* set function: EventAfterInputProcessing of class  Ember::Application */
#ifndef TOLUA_DISABLE_tolua_set_Ember__Application_EventAfterInputProcessing
static int tolua_set_Ember__Application_EventAfterInputProcessing(lua_State* tolua_S)
{
  Ember::Application* self = (Ember::Application*)  tolua_tousertype(tolua_S,1,0);
#ifndef TOLUA_RELEASE
  tolua_Error tolua_err;
  ...
  if (!tolua_isusertype(tolua_S,2,"sigc::signal<void,float>",0,&tolua_err))
   tolua_error(tolua_S,"#vinvalid type in variable assignment.",&tolua_err);
#endif
  self->EventAfterInputProcessing = *((sigc::signal<void,float>*)  tolua_tousertype(tolua_S,2,0))
;
 return 0;
}
#endif //#ifndef TOLUA_DISABLE
 ...
 tolua_beginmodule(tolua_S,NULL);
  ...
  tolua_beginmodule(tolua_S,"Ember");
   ...
   tolua_beginmodule(tolua_S,"Application");
    ...
    tolua_variable(tolua_S,"EventBeforeInputProcessing",tolua_get_Ember__Application_EventBeforeInputProcessing,tolua_set_Ember__Application_EventBeforeInputProcessing);
    tolua_variable(tolua_S,"EventAfterInputProcessing",tolua_get_Ember__Application_EventAfterInputProcessing,tolua_set_Ember__Application_EventAfterInputProcessing);
