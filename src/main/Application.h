 ...
 *
 *      $Log$
 *      Revision 1.26  2004-11-04 21:40:26  erik
...
namespace Ember 
{
    ...
    public:    
        /**
         * Ctor for Ember::Application.  Allcoates and pops up an SDL window 
         ...
         * @param title The title of the Application window(default="Ember Application")
         */      
        Application(int width=640, int height=480, std::string title="Ember Application");
	...
	void escPressed(InputDevice * , InputDevice * keyDevice, const EmberKey &key, InputMapping::InputSignalType signaltype)
	  {
	    quit();
	  }
	...
	StateManager *getStateMgr()
	  {
		...
		try
		  ...
		  {
		    EmberServices::getInstance()->getLoggingService()->log(__FILE__, __LINE__,
				 Ember::LoggingService::FAILURE,
				 stateMgrErr);
