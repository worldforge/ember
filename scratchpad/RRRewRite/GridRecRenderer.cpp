#include "GridRecRenderer.h"

/**
 * Constructor for a grid object
 */
dime::GridRecRenderer::GridRecRenderer(const Rectangle &rect,
 ...
 */
void dime::GridRecRenderer::updateGridDimensions()
{
    int xOffset, yOffset;
...
void dime::GridRecRenderer::setRect(const Rectangle &rect)
{
	myRect = rect;
	updateGridDimensions();
}
