...
Bonhomme::Bonhomme(Ogre::String const &name)
{
	...
	else
	{
		...
		/* Set manually controlled mode on the skeleton */
		setManualControl();

		/* Add behaviors and controllers. */
		mCharacter->createStandardControllers();

		/* TODO: correct the double link list corruption generated by the following lines. */
